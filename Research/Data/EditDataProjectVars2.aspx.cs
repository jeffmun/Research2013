...
public partial class Data_EditDataProjectVars2 : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!IsPostBack)
		{
			...
			if (Request.QueryString["pk"] != null)
			{
				...
				//TODO Check to see if IntHx is part of this study
...
protected void Load_for_View_Datafiles(int dataproj_pk, SQL_utils sql)
	...
	protected void 	btn_Edit_Command(object sender, CommandEventArgs e)
	{
		...
		else if (e.CommandName == "Cancel")
		{
			...
			//	panelSubjects_VIEW.Visible = true;
			//	panelSubjects_EDIT.Visible = false;
			//}
			//else if (e.CommandArgument.ToString() == "Measures")
			//{
			//	panelMeasures_VIEW.Visible = true;
			//	panelMeasures_EDIT.Visible = false;
			//}
			//else if (e.CommandArgument.ToString() == "IntHx")
			//{
			//	panel_IntHx_VIEW.Visible = true;
			//	panel_IntHx_EDIT.Visible = false;
			//}
