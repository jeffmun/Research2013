<%@ Page Title="Edit Data Project" Language="C#" EnableEventValidation="false" MasterPageFile="~/UWAC.master"
	 AutoEventWireup="true" CodeFile="EditDataProject2.aspx.cs" Inherits="Data_EditDataProject2" %>
...
<dx:ASPxButton ID="btnSubmit" runat="server" Text="Submit for approval" ForeColor="Gray"  ImagePosition="Right" Image-IconID="mail_emailtemplate_16x16office2013" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" 
	ToolTip="Edit Summary" AutoPostBack="false" >
...
<%--Title, Supervisor--%>
	<dx:ASPxPanel ID="panelTitle" runat="server" Visible ="true" >
		<PanelCollection>
			<dx:PanelContent>
		...
		<tr>
			<td style="vertical-align:top">
				<br />
				<dx:ASPxPanel ID="panelTitle_VIEW" runat="server" ClientVisible="true" ClientInstanceName="title_view">
					<PanelCollection>
					<dx:PanelContent>
					<table>
						<tr>
							<td style="vertical-align: top">
								...
								<asp:Label ID="Label3" runat="server" Text="Title:" Font-Bold="true" Font-Size="10" />
								<br />
								<dx:ASPxButton ID="ASPxButton13" runat="server" Text="Edit" ForeColor="Gray" ImagePosition="Right" Image-IconID="actions_edit_16x16devav" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" 
									ToolTip="Edit Summary" AutoPostBack="false" >
												<ClientSideEvents Click="function(s,e) {title_edit.SetVisible(true); title_view.SetVisible(false);}"  />
									</dx:ASPxButton>
							</td>
								...
								<table>
									<tr>
										<td style="width: 100px">
											<asp:Label ID="Label4" Text="Author:" runat="server" Font-Size="Small" Font-Bold="false" ></asp:Label>    
										</td>
										<td>
											<asp:Label ID="lblAuthor" runat="server" Font-Size="Small" ></asp:Label> (<asp:Label ID="lblAuthor_email" runat="server" Font-Size="Small"></asp:Label>)
										</td>
									</tr>
									<tr>
										<td style="width: 100px">
											<asp:Label ID="Label11" Text="Supervisor:" runat="server" Font-Size="Small" Font-Bold="false" ></asp:Label>    
										</td>
										<td>
											<asp:Label ID="lblSupervisor" runat="server" Font-Size="Small"></asp:Label> (<asp:Label ID="lblSupervisor_email" runat="server" Font-Size="Small" ></asp:Label>)
											&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<dx:ASPxPanel ID="panelTitle_EDIT" runat="server" ClientVisible="false" ClientInstanceName="title_edit">
					<PanelCollection>
					<dx:PanelContent>
						<table>
							<tr>
								...
								<td style="vertical-align: top">
									<asp:Label ID="Label13" runat="server" Text="Title:" Font-Bold="true" Font-Size="10" />
									<br />
									<dx:ASPxButton ID="ASPxButton14" runat="server" Text="Cancel" ImagePosition="Right" Image-IconID="actions_cancel_16x16" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" 
										ToolTip="Edit Summary" AutoPostBack="false" >
											<ClientSideEvents Click="function(s,e) {title_edit.SetVisible(false); title_view.SetVisible(true);}"  />
									</dx:ASPxButton>
									<br /><br /><br /><br />
									<dx:ASPxButton ID="ASPxButton15" runat="server" Text="Save" ImagePosition="Right" Image-IconID="save_save_16x16gray" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" 
										ToolTip="Edit Summary" OnCommand="btn_Edit_Command" CommandName="Save" CommandArgument="Title"></dx:ASPxButton>

								</td>
								<td style="width: 50px"></td>
								<td style="vertical-align: top">
									<asp:TextBox ID="txtTitle" Width="800" runat="server" Font-size="Medium" Font-Bold="true" ></asp:TextBox> 
									<br />
									<table>
									<tr>
										<td style="width: 100px">
											<asp:Label ID="Label16" Text="Supervisor:" runat="server" Font-Size="Small" Font-Bold="false" ></asp:Label>    
										</td>
										<td>
											<br />
					...
					<table>
						<tr>
							<td style="vertical-align: top">
								...
								<br />
								<dx:ASPxButton ID="ASPxButton10" runat="server" Text="Edit" ForeColor="Gray"  ImagePosition="Right" Image-IconID="actions_edit_16x16devav" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" 
									ToolTip="Edit Summary" AutoPostBack="false" >
												<ClientSideEvents Click="function(s,e) {summary_edit.SetVisible(true); summary_view.SetVisible(false);}"  />
									</dx:ASPxButton>
							</td>
						...
						<table>
							<tr>
								...
								<td style="vertical-align: top">
									...
									<br />
									<dx:ASPxButton ID="ASPxButton12" runat="server" Text="Cancel" ImagePosition="Right" Image-IconID="actions_cancel_16x16" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" 
										ToolTip="Edit Summary" AutoPostBack="false" >
											<ClientSideEvents Click="function(s,e) {summary_edit.SetVisible(false); summary_view.SetVisible(true);}"  />
									</dx:ASPxButton>
									<br /><br /><br /><br />
									<dx:ASPxButton ID="ASPxButton11" runat="server" Text="Save" ImagePosition="Right" Image-IconID="save_save_16x16gray" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" 
										ToolTip="Edit Summary" OnCommand="btn_Edit_Command" CommandName="Save" CommandArgument="Summary"></dx:ASPxButton>

								</td>
								<td style="width: 50px"></td>
								<td style="border-color: silver; border-style: solid">
									<dx:ASPxHtmlEditor ID="Summary_HtmlEditor" runat="server" Height="900px" Width="1000px" >
									</dx:ASPxHtmlEditor>
								</td>
							</tr>
						</table>
							...
							<table>
								<tr>
									<td style="vertical-align:top">
										...
										<br />
										<dx:ASPxButton ID="btnEdit_Subjects" runat="server" Text="Edit" ForeColor="Gray" ImagePosition="Right" Image-IconID="actions_edit_16x16devav" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" ToolTip="Edit Subjects" 
											 AutoPostBack="false" >
									...
									<td style="vertical-align: top">
										<table>
											<tr>
												<td>Group by Subject Status</td>
												<td style="width: 30px"></td>
												<td>Group by Sex, Race, Ethnicity</td>
											</tr>
											<tr>
												<td style="vertical-align: top">
												...
												<td style="width: 30px"></td>
												<td style="vertical-align: top">
													<dx:ASPxPivotGrid ID="pivotSubjects2" runat="server" OptionsCustomization-AllowFilter="false" OptionsView-ShowFilterHeaders="false">
														<Fields>
															<dx:PivotGridField Area="RowArea" AreaIndex="0" FieldName="Group" ID="fldGroup2" Caption="Group" Options-AllowFilter="false" Options-AllowSort="false" />
															<dx:PivotGridField Area="ColumnArea" AreaIndex="0" FieldName="sex" ID="fldSex" Caption="Sex" Options-AllowFilter="false" Options-AllowSort="false"/>
															<dx:PivotGridField Area="ColumnArea" AreaIndex="1" FieldName="race" ID="fldRace" Caption="Race" Options-AllowFilter="false" Options-AllowSort="false"/>
															<dx:PivotGridField Area="RowArea" AreaIndex="1" FieldName="ethnicity" ID="fldEthnicity" Caption="Ethnicity" Options-AllowFilter="false" Options-AllowSort="false"/>
															<dx:PivotGridField Area="DataArea" AreaIndex="0" FieldName="id" ID="fieldID2" Caption="ID" SummaryType="Count" />
														</Fields>
													</dx:ASPxPivotGrid>
												</td>
											</tr>
						...
						<table>
							<tr>
								<td style="vertical-align: top">
									...
									<br />
									<dx:ASPxButton ID="ASPxButton3" runat="server" Text="Edit" ForeColor="Gray" ImagePosition="Right" Image-IconID="actions_edit_16x16devav" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" ToolTip="Edit Subjects" 
									   AutoPostBack="false" >
									...
									<asp:GridView ID="gvViewMeas" runat="server" AutoGenerateColumns="false"  EmptyDataText="No measures selected yet."
										...
										<Columns>
											...
											<asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Select Vars">
												<ItemTemplate>
													<%--TOFIX?--%>
													<%--<asp:Button ID="btnEditVars" runat="server" Text='<%#  "N=" + DataBinder.Eval(Container.DataItem, "[N_Vars]") %>'  Font-Size="XX-Small" 
														OnCommand="btnEditVars_Command" 
...
<%--									<obout:OboutButton ID="btnRefresh" runat="server" Font-Size="XX-Small" Text="Refresh" OnClick="btnRefresh_Click"></obout:OboutButton>--%>
	...
	<dx:ASPxPanel ID="panelIntHx" runat="server" Visible ="true" >
					...
					<table>
						<tr>
							<td style="vertical-align: top">
								...
								<br />
								<dx:ASPxButton ID="btnIntHxADD" runat="server" Text="Add" ForeColor="Gray" ImagePosition="Right" Image-IconID="actions_edit_16x16devav" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" ToolTip="Add IntHx to project" 
									AutoPostBack="false" >
												<ClientSideEvents Click="function(s,e) {OnNewIntHxClick(s, e); inthx_edit.SetVisible(true); inthx_view.SetVisible(false);}"  />
									</dx:ASPxButton>

								<dx:ASPxButton ID="btnIntHxEDIT" runat="server" Text="Edit" ForeColor="Gray" ImagePosition="Right" Image-IconID="actions_edit_16x16devav" Paddings-PaddingBottom="1" Paddings-PaddingLeft="1" Paddings-PaddingRight="1" Paddings-PaddingTop="1" Font-Size="10" ToolTip="Edit IntHx" 
									AutoPostBack="false" >
												<ClientSideEvents Click="function(s,e) {OnEditIntHxClick(s, e); inthx_edit.SetVisible(true); inthx_view.SetVisible(false); }"  />
									</dx:ASPxButton>
							</td>
							<td style="width: 50px"></td>
							<td style="vertical-align: top">
								<dx:ASPxGridView ID="gridViewIntHx" runat="server" DataSourceID="sqlIntHxParams" AutoGenerateColumns="False" Width="100%" KeyFieldName="dataproj_pk" ClientInstanceName="gridview_IntHx" >
								<Columns>
		<%--							<dx:GridViewDataCheckColumn  FieldName="includeWeeks" Caption="By Weeks"   VisibleIndex="1"></dx:GridViewDataCheckColumn>
									...
									<dx:GridViewDataTokenBoxColumn FieldName="periods" Caption="Included Periods" VisibleIndex="1">
									...
									<dx:GridViewDataTokenBoxColumn FieldName="types"  Caption="Included TxTypes" VisibleIndex="2">
									...
									<dx:GridViewDataTokenBoxColumn FieldName="cats"  Caption="Included TxCategories" VisibleIndex="3">
				...
				<dx:ASPxPanel ID="panel_IntHx_EDIT" runat="server" ClientVisible="false" ClientInstanceName="inthx_edit">
					...
					<table>
						<tr>
							...
							<td>
								...
								<br />
								<asp:Label ID="lblIntHxSettings_info" runat="server" Text="Note that the IntHx will be automatically aggregated in a number of ways in the data file." Font-Bold="true" Font-Size="X-Small" ></asp:Label>					

								<table style="border: solid; border-collapse: separate; border-color: silver; padding: 3px; text-align: center">
										<tr style="background-color:silver;">
											<td></td>
											<td><b>By Weeks</b></td>
											<td><b>Period By Type</b></td>
											<td><b>Period By Category</b></td>
											<td><b>... By Type</b></td>
					...
					<dx:ASPxGridView ID="gridIntHx" runat="server" DataSourceID="sqlIntHxParams" AutoGenerateColumns="False" Width="100%" KeyFieldName="dataproj_pk" 
						OnHtmlDataCellPrepared="gridIntHx_OnHtmlDataCellPrepared" ClientInstanceName="gridedit_IntHx" >
						<Columns>
...
<%--							<dx:GridViewDataCheckColumn  FieldName="includeWeeks" Caption="By Weeks"   VisibleIndex="1"></dx:GridViewDataCheckColumn>
	...
	<br /><br />
		...
		<script type="text/javascript">
			function OnNewIntHxClick(s, e) {
				gridedit_IntHx.AddNewRow();}
			function OnEditIntHxClick(s, e) {
				gridedit_IntHx.StartEditRow(0);
			}
		</script>
...
--%>
	...
	<asp:SqlDataSource ID="sqlIntHxParams" runat="server" 
		...
		InsertCommandType="Text" InsertCommand="insert into dp.IntHxPARAMS (periods, types, cats)
			values (@periods, @types, @cats)  where dataproj_pk=@dataproj_pk"
