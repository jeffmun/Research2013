<%@ Page Language="c#" Debug="true" MasterPageFile="../UWAC.master"
    CodeFile="Waitlist_reports.aspx.cs" AutoEventWireup="true" Inherits="Waitlist_Waitlist_Reports" Title="Waitlist" %>
...
<%--        <asp:BoundField DataField="SvcReq2" HeaderText="SvcReq2" SortExpression="SvcReq2" />        --%>
			...
			<asp:BoundField DataField="NavNotes" HeaderText="NavNotes" SortExpression="NavNotes" />
        </Columns>
    </asp:GridView>
            <br />
            <hr />
