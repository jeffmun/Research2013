<%@ Page Language="c#"  validateRequest="false" Debug="true" MasterPageFile="~/UWAC.master" CodeFile="IntHxSummary.aspx.cs" AutoEventWireup="True" 
	Inherits="stats_IntHxSummary" Title="IntHx v2 Summary & Charts"   EnableEventValidation="false"  EnableSessionState="ReadOnly"  %>
