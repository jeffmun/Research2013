<%@ Page   Language="C#" AutoEventWireup="true"  CodeFile="TrackReliability.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <div> &nbsp;<span style="font-family: Arial"></span><strong><span style="font-family: Arial"></span></strong>
        ...
        <table>
            <tr>
                <td style="width: 297px; text-align: left">
                    <strong><span style="font-family: Arial">Reliability
            Tracking</span></strong></td>
                <td style="width: 136px">
                </td>
                <td>
                     
                    <span style="font-size: 10pt; font-family: Arial"><a href="https://uwac.autism.washington.edu/Research">Return to Autism Home</a></span></td>
            </tr>
        </table>
        <br />
        ...
        <strong><span style="font-family: Arial"></span>
            ...
            <asp:SqlDataSource ID="Sql_ReliabilityTracking_Details" runat="server" ConnectionString="<%$ ConnectionStrings:TRACKING_CONN_STRING %>" 
                ...
                <UpdateParameters>
                    ...
                    <asp:ControlParameter  ControlID="GridView_Details$ctl03$DDL_RevStatus_UPDATE"  PropertyName="SelectedValue"  Name="relRevStatusID" Type=int32 />
                </UpdateParameters>
                <DeleteParameters>
        ...
        <asp:GridView ID="GridView_Details" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Review Status" SortExpression="relRevSortOrder">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DDL_RevStatus_UPDATE" runat="server" DataSourceID="Sql_RevStatus" DataValueField="relRevStatusID" DataTextField="relRevStatusText" ></asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
