<%@ Page MasterPageFile="~/UWAC.master" Language="C#" CodeFile="EditStudy.aspx.cs" Inherits="StudyDesign.EditStudy" %>
...
<table cellspacing="0" id="tblMaster" class="tblInputSmall" runat="server">
	...
	<tr>
		<td colspan="4">
			...
			<iframe id="oIFrame" runat="server" src="/" frameborder="0" scrolling="auto" style="background-color: #efefef; width: 100%; height: 600px; display: none; margin: 0px;"></iframe>
		</td>
	</tr>
</table>
