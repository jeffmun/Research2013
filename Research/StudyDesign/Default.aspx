...
<span style="font-size: 12pt; font-weight: bold;">Study Design &nbsp  &nbsp</span>
    ...
    <table >
        <tr>
            <td width="200px">
                <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="../StudyDesign/Default.aspx?viewrpt=1" EnableViewState=true  >Full Design</asp:LinkButton><br />
            </td>
            <td width="200px">
                            <asp:LinkButton ID="LinkButton8" runat="server" PostBackUrl="../StudyDesign/Default.aspx?viewrpt=8" EnableViewState=true >Measure Documents</asp:LinkButton><br />
        ...
        <tr>
            <td>
                <asp:LinkButton ID="LinkButton2" runat="server" PostBackUrl="../StudyDesign/Default.aspx?viewrpt=2" EnableViewState=true >Measures</asp:LinkButton><br />
            </td>
            <td>
                <asp:LinkButton ID="LinkButton7" runat="server" PostBackUrl="../StudyDesign/Default.aspx?viewrpt=7" EnableViewState=true >Testing Projections</asp:LinkButton><br />
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:LinkButton ID="LinkButton6" runat="server" PostBackUrl="../StudyDesign/Default.aspx?viewrpt=6" EnableViewState=true >Measures with DataTable info</asp:LinkButton><br />
            </td>
            <td>
                            <asp:LinkButton ID="LinkButton5" runat="server" PostBackUrl="../StudyDesign/Default.aspx?viewrpt=5" EnableViewState=true >All Related Documents</asp:LinkButton><br />

            </td>
            <td>
                <asp:LinkButton ID="LinkButton9" runat="server" PostBackUrl="../StudyDesign/Default.aspx?viewrpt=9" EnableViewState=true >Measures with Data Entry Plan</asp:LinkButton><br />
            </td>
        </tr>
    </table>
    <br />
