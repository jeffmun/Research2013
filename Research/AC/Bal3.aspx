<%@ Page Title="" Language="C#" MasterPageFile="~/UWAC.master" AutoEventWireup="true" CodeFile="Bal3.aspx.cs" Inherits="AC_Bal" %>
...
<%--    <div style="background-color: #fffff8; border: 2px solid black; margin: 10px" >
        ...
        <div id="chart_div" >
            ...
            <asp:Label ID="Label16" Text="63-0120, ???" Style="font-size: large" runat="server" /><br />
        ...
        <div id="chart_div">
            ...
            <asp:Label ID="Label17" Text="63-0555, ???" Style="font-size: large" runat="server" /><br />
        ...
        <div id="chart_div">
            ...
            <asp:Label ID="Label18" Text="631369, ???" Style="font-size: large" runat="server" /><br />
        ...
        <div id="chart_div">
            ...
            <asp:Label ID="Label19" Text="63-1370, ???" Style="font-size: large" runat="server" /><br />
        ...
        <div id="chart_div">
            ...
            <asp:Label ID="Label20" Text="634035, ???"   Style="font-size: large" runat="server" /><br />
