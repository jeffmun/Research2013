<%@ Page Language="c#"   Debug="true" MasterPageFile="~/UWAC.master" CodeFile="UWACscoring_subjects.aspx.cs" AutoEventWireup="true"
 Inherits="Tracking_UWACscoring_subjects" Title="Subjects Info"      %>   <%--Theme="Skin1" EnableEventValidation="true"--%>
...
<script type="text/javascript">
	...
	function SSCombo_SelectedIndexChanged(s, e) {
		gva.GetEditor("ssID").PerformCallback(s.GetValue());
	}
</script>
...
<%-- Select Controls --%>
		...
		<tr>
			...
			<td style="vertical-align: top; padding-left: 50px;">
				<dx:ASPxTextBox ID="txtFN" runat="server" Caption="First name:"></dx:ASPxTextBox>
				<dx:ASPxTextBox ID="txtLN" runat="server" Caption="Last name:"></dx:ASPxTextBox>
			</td>
			<td style="vertical-align: top; padding-left: 5px;">
				<dx:ASPxDateEdit ID="txtDOB" runat="server" Caption="DOB:"></dx:ASPxDateEdit>
				<dx:ASPxTextBox ID="txtID" runat="server" Caption="ID:"></dx:ASPxTextBox>
							</td>
			<td style="vertical-align: top; padding-left: 5px;">
				<dx:ASPxButton ID="btnNew" runat="server" Text="Create New Subject" OnClick="btnNew_Click"></dx:ASPxButton>
				<br />
				<dx:ASPxLabel ID="lblERR" runat="server" Text="" ForeColor="Red"></dx:ASPxLabel>
			</td>
			<td style="vertical-align: top">
				<dx:ASPxButton ID="btnLoad" runat="server" Text="Load Subjects" OnClick="btnLoad_OnClick" AutoPostBack="false" ClientInstanceName="btnLoad"  Visible="false">
					 <%--<ClientSideEvents Click="foo" />--%>
				</dx:ASPxButton>
				<dx:ASPxButton ID="btnClear" runat="server" Text="Clear" Width="30px" Font-Size="X-Small" ForeColor="Silver" BackColor="WhiteSmoke" AutoPostBack="false" Visible="false" >
					<ClientSideEvents Click="ClearSelected"    />
				</dx:ASPxButton>
				<br />
				<dx:ASPxRadioButtonList ID="rblObj" runat="server" Font-Size="9" Border-BorderStyle="None" RepeatColumns="3" Visible="false" >
					<Items>
	...
	<table>
		<tr>
			<td style="vertical-align:top">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<dx:ASPxLabel ID="lblSelectInstructions" runat="server" Text="Use Ctl-Click or Shift-Click to select multiple rows and edit them simultaneously" Visible="false" Font-Size="9" Font-Italic="true"  ForeColor="LIGHTSLATEGRAY"></dx:ASPxLabel>
				<br />
...
<%--                        <dx:GridViewCommandColumn ShowEditButton="true" Caption="Edit" VisibleIndex="0" Width="60px" ></dx:GridViewCommandColumn>--%>
						...
						<dx:GridViewDataColumn FieldName="ssID" Caption="Status" VisibleIndex="3">
							<DataItemTemplate>
								<dx:ASPxLabel ID="lblSubjectStatus" runat="server" Text='<%# Eval("subjstatus") %>' ></dx:ASPxLabel>
							</DataItemTemplate>
						</dx:GridViewDataColumn>
						<dx:GridViewDataColumn FieldName="ssdID" Caption="Status Detail" VisibleIndex="4">
							<DataItemTemplate>
								<dx:ASPxLabel ID="lblSubjectStatusDetail" runat="server" Text='<%# Eval("subjstatusdetail") %>' ></dx:ASPxLabel>
							</DataItemTemplate>
						...
						<dx:GridViewDataColumn FieldName="notes"  VisibleIndex="10"></dx:GridViewDataColumn>
									...
									<dx:ASPxComboBox ID="cboSSD" runat="server" ValueType="System.Int32" OnInit="cboSSD_Init"  DropDownStyle="DropDown" >
										...
										<asp:SqlDataSource ID="sqlSSD_by_SS" runat="server" SelectCommandType="StoredProcedure"  
											...
											<SelectParameters>
												...
												<asp:Parameter Name="ssID"  DbType="Int32" />
											</SelectParameters>
										</asp:SqlDataSource>
