<%@ Page Title="" Language="C#" MasterPageFile="~/UWAC.master" AutoEventWireup="true" CodeFile="EditEntity2.aspx.cs" Inherits="Admin_EditEntity2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" Runat="Server">
		...
		<script type="text/javascript">
		    ...
		    function SetupDetailDDL(oRecord) {

		        //set the value of the DLL
		        setDDL(ddl_master_pk, oRecord["master_pk"]);
		        setDDL(ddl_detail_pk, oRecord["detail_pk"]);

		    }

		    function setDDL(ddl, selval)
		    {
		        for (var opts = 0; opts < ddl.options.length; opts++) {
		            if (ddl.options[opts].value == selval) {
...
<tr>
	...
	<td style="vertical-align:top" style="width: 100px;">
		<asp:Panel ID="panelHyperlinks1" runat="server"></asp:Panel>
	</td>
		<td style="vertical-align:top">
		<asp:Panel ID="panelHyperlinks2" runat="server"></asp:Panel>
	</td>
</tr>
</table>
...
<tr>
	...
	<td style="vertical-align:top">
		<obout:Grid ID="ogrid" runat="server"    CallbackMode="false" Serialize="true" AutoGenerateColumns="true" AllowAddingRecords="true" 
				OnRowDataBound="ogrid_RowDataBound"
			...
			<td style="vertical-align:top">
				<br /><br /><br />
			<asp:Button ID="btnLoadDetails" runat="server" Text=" " OnClick="btnLoadDetails_Click" Visible="false" />
		</td>
	...
	<td style="vertical-align:top">
		   ...
		   AllowSorting="true" PageSize="-1"  AllowColumnResizing="false"   OnColumnsCreated="ogrid_detail_ColumnsCreated" ShowFooter="false" Visible="false"
				 FolderStyle="~/App_Obout/Grid/styles/gray_glass">
		<AddEditDeleteSettings NewRecordPosition="Top" AddLinksPosition="Top" />
				<ClientSideEvents OnClientPopulateControls="SetupDetailDDL" ExposeSender="false" />
	</obout:Grid>
