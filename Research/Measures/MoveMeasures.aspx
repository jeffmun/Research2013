<%@ Page Language="c#" MasterPageFile="~/PopUp.master" CodeFile="MoveMeasures.aspx.cs" AutoEventWireup="True" Inherits="Measures.MoveMeasures" EnableEventValidation="False" %>
...
<table cellspacing="0" class="tblInput" style="width: 100%; margin-left: 0px; margin-right: 0px;">
	<tr class="trTitle">
		<td>Move Measures to Different Action</td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			...
			<asp:HiddenField id="hidStudyMeasSubjIDs" runat="server" />
		</td>
	</tr>
</table>
