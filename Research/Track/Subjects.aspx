	...
	<table>
		<tr>
			<td style="vertical-align:top">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<dx:ASPxLabel ID="lblSelectInstructions" runat="server" Text="Use Ctl-Click or Shift-Click to select multiple rows and edit them simultaneously"  Font-Size="9" Font-Italic="true"  ForeColor="LIGHTSLATEGRAY"></dx:ASPxLabel>
				<br />
