<%@ Page Language="c#" Debug="true" MasterPageFile="~/UWAC.master" AutoEventWireup="true" CodeFile="ViewDoc2.aspx.cs" Inherits="Documents_ViewDoc2" Title="Doc Viewer" 
...
<br />
<br />
    <asp:HyperLink ID="HyperLink1" runat="server">Direct Link to your File</asp:HyperLink>
--%><br />
<br />
    <asp:Button ID="btnViewIt" runat="server" Text="ViewIt" OnClick="ViewIt" />
                ...
                <table  border="0" bordercolor="#ffffff" cellpadding="1" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2" width="600px">
                            ...
                            <asp:Label ID="VersionLabel" runat="server" Font-Bold="True" Text='<%# Eval("Version") %>' Font-Size="11pt" ></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <td>
            ...
            <tr>
                <td style="vertical-align:top">
                    ...
                    <asp:Label ID="Label7" runat="server" Text="This document is linked to the following database objects:" Font-Size="9pt"></asp:Label>
                    <br />
