...
using AutismCenterBase.Utilities;
	...
	public partial class Documents_ViewDoc2 : System.Web.UI.Page
	{
		...
		public String[] allowedExtensions = { ".docx", ".xlsx", ".pptx", ".doc", ".xls", ".ppt", ".pdf", ".rtf" , ".txt", ".csv", 
											 ...
											 ".sps", ".sav", ".spo", ".R", ".Rdata", ".Rnw", ".zip"};
			

		protected void ViewIt(object sender, EventArgs e)
		{
			Response.Redirect("https://uwac.autism.washington.edu/research/webdocs/DocVersID_1301.pdf");
		}
		...
		protected void LoadDoc()
		{
			...
			if (FormView1.CurrentMode == FormViewMode.ReadOnly)
			{
					...
					fileext_output.ToLower() == ".R")
				{
					...
					//FIX Label_Error.Text = "";
					Label_Error.Text = ((Label)this.FormView1.FindControl("DocLinkLabel")).Text;
				}
				else
				{
