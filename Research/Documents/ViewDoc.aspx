<%@ Page Language="c#" Debug="true" MasterPageFile="~/UWAC.master" AutoEventWireup="true" CodeFile="ViewDoc.aspx.cs" Inherits="Documents_ViewDoc" Title="Doc Viewer" 
...
<br />
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<br />
     <asp:Label ID="lblFilePath" runat="server" ForeColor="SkyBlue" Visible="true" ></asp:Label><br />
        <table >
        ...
        OnItemInserting="FormView1_ItemInserting" OnItemUpdated="FormView1_ItemUpdated" OnItemInserted="FormView1_ItemInserted"
         OnItemDeleted="FormView1_ItemDeleted">
            ...
            <ItemTemplate>
                ...
                <table  border="0" bordercolor="#ffffff" cellpadding="1" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2" width="600px">
                            ...
                            <asp:Label ID="DocTitleLabel" runat="server" Font-Bold="True" Text='<%# Bind("DocTitle") %>' Width = "400px" Font-Size="12pt"></asp:Label>
                ...
                <br />
        <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="Edit Doc Info/Replace file"  Font-Size="8pt" UseSubmitBehavior="false" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <%--  <asp:Button ID="ReplaceButton" runat="server" Text="Replace this version with different file" CommandName="Replace"  Width="120px" Font-Size="8pt"/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
        ...
        <br />
        <br />
        <asp:Label ID="lblDocUploadInfo" runat="server" ForeColor="Red" Text=""></asp:Label>&nbsp;<br />

        <asp:Button ID="btnDownloadFile" runat="server" Visible="false" OnCommand="btnDownloadFile_Command" CommandName="DownloadFile" UseSubmitBehavior="true" />        
...
<%--                    <tr>
        ...
        <%---------------- Other Versions ---------------%>
                ...
                <tr>
                    ...
                    <asp:Label ID="Label14" runat="server" ForeColor="Navy" Text="Other versions of this document:" Font-Size="9pt"></asp:Label>
                    <asp:Label ID="Label15" runat="server" ForeColor="Blue" Text="(Click version # to view)" Font-Size="8pt"></asp:Label>
                        <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="DocVersID" BorderStyle="None" BorderWidth="0"
        ...
        <br/><br/>
            ...
            <tr>
                <td style="vertical-align:top">
                    ...
                    <asp:Label ID="Label7" runat="server" ForeColor="Navy" Text="This document is linked to the following objects:" Font-Size="9pt"></asp:Label>
                    <br />
                    <asp:GridView ID="GridView2" runat="server" BorderStyle="None" BorderWidth="0"
                   ...
                   <%--     <asp:BoundField DataField="EntityName" HeaderText="EntityName" />--%>
                        <asp:TemplateField>
                            <HeaderTemplate >EntityName</HeaderTemplate>
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Blue" Text='<%# DataBinder.Eval(Container.DataItem, "EntityName") %>' NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "link") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
...
<%--    <asp:Button ID="Button1" runat="server" Text="ClickForFile" OnClick="ClickForFile" /><br />--%>
