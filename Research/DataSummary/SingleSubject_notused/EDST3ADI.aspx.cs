...
namespace DataSummary.SingleSubject
{
	...
	public partial class EDST3ADI : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if (!IsPostBack)
			{
				...
				oDBLookup.BindDropDownList(ref selSubjectID, "EXEC spGetSubjectsByStudy 3", "ID", "ID", "", "--Select Subject--");
			}
		}
		...
		protected void GetADI(object sender, EventArgs e)
		{
			...
			{
				ADI oADI = new ADI();
				oADI.Study = ADI.Studies.EearlyDevelopmentStudyTime3;
