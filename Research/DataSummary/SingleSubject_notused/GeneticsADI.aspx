<%@ Page Language="C#" MasterPageFile="~/UWAC.master" CodeFile="GeneticsADI.aspx.cs" Inherits="DataSummary.SingleSubject.GeneticsADI" %>
<%@ MasterType VirtualPath="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">

<table class="tblInput" cellspacing="0" id="tblMaster" runat="server">
	<tr class="trTitle">
		<td>Genetics ADI - Single Subject Summary</td>
	</tr>
	<tr>
