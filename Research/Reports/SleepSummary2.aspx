<%@ Page Language="c#"   Debug="true" MasterPageFile="~/UWAC.master" AutoEventWireup="true" EnableEventValidation="true"
  CodeFile="SleepSummary2.aspx.cs" Inherits="Reports_SleepSummary2"  Title ="Summary of sleep data"    %>  
...
<asp:Content ID="Content1"  ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
	...
	<dx:ASPxLabel ID="lblSetupInfo" runat="server" EncodeHtml="false"></dx:ASPxLabel>
		...
		<br />
	<br />
	<dx:ASPxLabel ID="lblSubjectInfo" runat="server" Font-Bold="true" Font-Size="Large" EncodeHtml="false"></dx:ASPxLabel>
	...
	<table>
		<tr>
			<td style="vertical-align:top">
				<dx:ASPxPanel ID="panel1" runat="server" ></dx:ASPxPanel>
			</td>
			<td style="vertical-align:top; padding-left:100px">
				<dx:ASPxPanel ID="panel2" runat="server" ></dx:ASPxPanel>
			</td>
		</tr>
	</table>
	<dx:ASPxPanel ID="panel_sleepdiary" runat="server" ></dx:ASPxPanel>
