...
<%@ Page Language="c#" Debug="true" MasterPageFile="~/UWAC.master" CodeFile="StudyNs.aspx.cs" AutoEventWireup="true"
 Inherits="Tracking_StudyNs" Title="Study Ns"   Theme="Skin1" %>
...
<style type="text/css">
	...
	<asp:DropDownList ID="ddlPI" runat="server" DataSourceID="sqlPI" DataTextField="pi_name" DataValueField="staffID" 
...
<%--	<asp:Label ID="label3" runat="server" Text="Subjects" Font-Bold="true"></asp:Label><br />
	...
	<asp:SqlDataSource ID="sqlPI" runat="server" ConnectionString="<%$ ConnectionStrings:TRACKING_CONN_STRING %>"
