<%@ Page Language="c#"   Debug="false" MasterPageFile="~/UWAC.master" CodeFile="Measures - Copy.aspx.cs" AutoEventWireup="true"
            ...
            <td style="vertical-align:top">
                    ...
                    <dx:ASPxGridView ID="gvM" runat="server"    AutoGenerateColumns="false"  ClientInstanceName="gvm" Visible="false"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="ActionText" Caption="Action" ReadOnly="true" VisibleIndex="10"></dx:GridViewDataColumn>
                        ...
                        <EditFormLayoutProperties ColCount="3"  >
                            ...
                            <Items>
                                ...
                                <dx:GridViewColumnLayoutItem Caption="Date Done" RowSpan="2"   VerticalAlign="Top">
                                    <Template>
                                        <dx:ASPxCalendar ID="DateCalendar" runat="server" Value='<%# Bind("Date") %>' />
                                    </Template>
                                </dx:GridViewColumnLayoutItem> 
