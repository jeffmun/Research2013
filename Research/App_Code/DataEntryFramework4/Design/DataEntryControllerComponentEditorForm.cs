...
//			txtSqlTable.Text = "edst3_ppvt";
		...
		private void InitializeComponent()
		{
			...
			this.label5.Text = "v 1.1.0";
			// 
			// txtFile
			// 
			this.txtFile.Location = new System.Drawing.Point(208, 352);
			...
			// btnSelectFile
			// 
			this.btnSelectFile.Location = new System.Drawing.Point(544, 352);
			this.btnSelectFile.Name = "btnSelectFile";
			this.btnSelectFile.TabIndex = 64;
			this.btnSelectFile.Text = "Label File";
			this.btnSelectFile.Click += new System.EventHandler(this.btnSelectFile_Click);
			// 
			// label6
			// 
			this.label6.Location = new System.Drawing.Point(480, 384);
			this.label6.Name = "label6";
			this.label6.Size = new System.Drawing.Size(144, 72);
			this.label6.TabIndex = 66;
			this.label6.Text = "Label file should be a tab delimited file with column names in first column and f" +
				"ield label text in second.";
			// 
...
//		}
			...
			try 
			{
				...
				foreach (DataColumn c in dt.Columns)
				{
					...
					else if (c.ColumnName.ToUpper() == _verifiedFieldColumnName.ToUpper())
					{
						...
						|| c.ColumnName.ToLower() == "scored" || c.ColumnName.ToLower() == "scoredby" )
						df.IsReadOnly = true;
		...
		private Hashtable ParseIntoHashtable(string inFile)
		{
			...
			try 
			{
				...
				//				foreach(String[] sr in vals)
				//				{
				//					System.Console.WriteLine(sr[0]);
				//					System.Console.WriteLine(sr[1]);
				//				}
...
//				textBox2.Text = (idh == null)?"idh is null": "idh is not null";
		...
		private void btnCreateFields_Click(object sender, System.EventArgs e)
		{
			...
			*/
			...
			//apply field labels from file, if any
			if (this.txtFile.Text.Trim() != string.Empty)
			{
				Hashtable htLabels = ParseIntoHashtable(this.txtFile.Text.Trim());
				if (htLabels != null)
				{
					foreach(DataFieldColumn d in _dataFieldColumns)
					{

						object oLabel = htLabels[d.ColumnName];
						if (oLabel != null)	d.FieldLabel = (string)oLabel;
					}
				}
			}
...
//			}
		...
		private void btnSelectFile_Click(object sender, System.EventArgs e)
		{
			...
			openFileDialog1.Filter = "STD Files (*.txt)|*.txt";
