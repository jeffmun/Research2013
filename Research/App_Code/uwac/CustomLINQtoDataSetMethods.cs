...
namespace uwac
{
	...
	/// <summary>
	/// Summary description for CustomLINQtoDataSetMethods
	/// </summary>
	/// 

	//from https://docs.microsoft.com/en-us/dotnet/framework/data/adonet/implement-copytodatatable-where-type-not-a-datarow 
	// see this webpage for additional info regarding changes that allow it to handle nullable types
		...
		public DataTable ExtendTable(DataTable table, Type type)
		{
			...
			foreach (FieldInfo f in type.GetFields())
			{
				if (!_ordinalMap.ContainsKey(f.Name))
				{
					...
					//THIS LINE REPLACED WITH THE FOLLOWING BECAUSE IT DOESN'T HANDLE NULLABLE TYPES
					...
					else
					{
						...
						bool nullable = !fieldType.IsPrimitive;
						...
						dc = table.Columns.Add(f.Name, fieldType);
