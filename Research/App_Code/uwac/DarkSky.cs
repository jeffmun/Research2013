...
namespace uwac
{
	...
	{
		private DarkSkyService client { get; set; }
		//Jeff Munson API key
		...
		public async Task GetWeather(double lat, double lon, DateTimeOffset date)
		{
			//DarkSkyService client = new DarkSkyService("9a9c19a4d9a62d812bf17136c99cc6cf");
