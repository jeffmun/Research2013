...
namespace uwac
{
    ...
    public class utilPivot
    {
        ...
        public static DataTable Pivot(DataTable dt, List<string> keepCols, string pivotColumn, List<string> pivotValues)
        {

            DataTable dt_pivot = utilPivot.Pivot(dt, keepCols, dt.Columns[pivotColumn], pivotValues, "", "");

            return dt_pivot;
        }

        
        public static DataTable Pivot(DataTable dt, List<string> keepCols, string pivotColumn, string pivotValue)
        {
            DataTable dt_pivot = utilPivot.Pivot(dt, keepCols, dt.Columns[pivotColumn], dt.Columns[pivotValue], "", "");
            return dt_pivot;
        }
        public static DataTable Pivot(DataTable dt, List<string> keepCols, string pivotColumn, string pivotValue, string sortRowsBy, string sortColsBy)
        {
            DataTable dt_pivot = utilPivot.Pivot(dt, keepCols, dt.Columns[pivotColumn], dt.Columns[pivotValue], sortRowsBy, sortColsBy);
            return dt_pivot;
        }



        public static DataTable Pivot(DataTable dt, List<string> keepCols, DataColumn pivotColumn, DataColumn pivotValue, string sortRowsBy, string sortColsBy)
        {
            ...
            List<string> ColumnNames = temp.Columns.Cast<DataColumn>()
            ...
            //to remove
            removevars = removevars.Except(new List<string> { pivotColumn.ColumnName, pivotValue.ColumnName});
            if (sortColsBy != "")
            {
                removevars = removevars.Except(new List<string> { pivotColumn.ColumnName, pivotValue.ColumnName, sortColsBy});
            }
            else
            {
                removevars = removevars.Except(new List<string> { pivotColumn.ColumnName, pivotValue.ColumnName });
        ...
        public static DataTable Pivot(DataTable dt, List<string> keepCols, DataColumn pivotColumn, List<string> pivotValues, string sortRowsBy, string sortColsBy)
        {
            //Sort the data so that columns will be sorted
            DataView dv = new DataView(dt);
        ...
        public static DataTable Pivot(DataTable dt, DataColumn pivotColumn, List<string> pivotValues)
        {
        ...
        //multiple pvotValue columns
        public static DataTable Pivot(DataTable dt, DataColumn pivotColumn, List<string> pivotValues, string newcolumnorder )
        {
        ...
        ////multiple pvotValue columns
        //public static DataTable PivotX(DataTable dt, List<string> pivotColumns, List<string> pivotValues, string newcolumnorder)
        //{
        //    DataColumn pivotColumn;
        //    //IEnumerable<Option> allOptions = optiongroup.Options.OrderByDescending(o => o.SortOrder);
        ...
        //    foreach(string col in pivotColumns)
        //    {
        //        temp.Columns.Remove(col);
        //    }
        ...
        //    //Add columns for each seperate pivotValue
        //    foreach (string str_pivotValue in pivotValues)
        //    {
        //        DataColumn pivotValue = dt.Columns[str_pivotValue];
        //        string suffix = str_pivotValue;
        ...
        #region Sort tables
        public static DataTable SortTable(DataTable dt, string sortRowsBy, string sortColsBy)
        {
            //Sort the data so that columns will be sorted
            DataView dv = new DataView(dt);
        ...
        public static GridView FixHeadersAfterPivot(DataTable dt, List<string> keepCols, string pivotColumn, List<string> pivotValues, string cornerText = "")
        {
            ...
            GridViewRow eRow = gv.HeaderRow;

            //create the new corner cell
            int ncols = dt.Columns.Count;
            int ncols_in_pivot = dt.Columns.Count - keepCols.Count;
            ...
            for (int i = 0; i < pivotValues.Count; i++)
            {
                ...
                for (int j = 0; j < ncells_in_set; j++)
                {
                    ...
                    string oldtxt = eRow.Cells[idx].Text;
                    string newtext = oldtxt.Replace("_" + pivotValues[i], "");
                    eRow.Cells[idx].Text = newtext;
        ...
        //private void CopyColumns(DataTable source, DataTable dest, params List<string> columns)
        //{
        ...
        //public DataTable MergeMSD(DataTable dt, string x1, string x2, List<string> stats)
        //{
