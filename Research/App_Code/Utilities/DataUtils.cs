...
namespace uwac
{
    ...
    public class DataUtils
    {
        ...
        public static DataTable Pivot(DataTable dt, string[] keepCols, string pivotColumn, string[] pivotValues)
        {
            ...
            DataTable dt_pivot = DataUtils.Pivot(dt, keepCols, dt.Columns[pivotColumn], pivotValues, "", "");
        ...
        {
            DataTable dt_pivot = DataUtils.Pivot(dt, keepCols, dt.Columns[pivotColumn], dt.Columns[pivotValue], "", "");
            return dt_pivot;
        }
        ...
        {
            DataTable dt_pivot = DataUtils.Pivot(dt, keepCols, dt.Columns[pivotColumn], dt.Columns[pivotValue], sortRowsBy, sortColsBy);
            return dt_pivot;
        }
        ...
        //try it with multiple pvotValue columns
        public static DataTable Pivot(DataTable dt, DataColumn pivotColumn, string[] pivotValues)
        {
            ...
            //foreach (DataColumn pivotValue in pivotValues)
            //{
            foreach (string str_pivotValue in pivotValues)
            {
