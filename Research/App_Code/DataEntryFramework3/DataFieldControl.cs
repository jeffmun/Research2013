...
namespace DataEntryFramework3
{
	...
	Designer(typeof(DataEntryFramework3.Design.DataFieldControlDesigner)),
	...
	public class DataFieldControl : System.Web.UI.WebControls.WebControl, INamingContainer
	{
		...
		public List<string> PreValidate()
		{
			...
			{
				errors.Add("A value for the DatabaseField property is required.");
			}
		...
		public List<string> ValidateAndInitializeProperties()
		{
			...
			#region DatabaseField, ID, FieldDataType
		...
		//{
		//    Page.Trace.Write("DataFieldControl: " + this.DatabaseField, "Begin Load");



		//    base.OnLoad(e);
		//    Page.Trace.Write("DataFieldControl: " + this.DatabaseField, "End Load");
		//}
		...
		public IFieldMetadata FieldMetadata
		{
			...
			{ 
				...
				//
				//The DatabaseField property is not set because it must already exist.
				if (value != null)
				{
					//save reference
