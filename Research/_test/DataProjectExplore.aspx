<%@ Page Language="C#" Debug="true"  MasterPageFile="~/UWAC.master"  AutoEventWireup="true" CodeFile="DataProjectExplore.aspx.cs" Inherits="_test_DataProjectExplore" 
...
<%@ Register Assembly="DevExpress.XtraCharts.v18.1, Version=18.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraCharts" TagPrefix="dxch" %> 

<%@ Register Assembly="DevExpress.XtraCharts.v18.1, Version=18.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraCharts" TagPrefix="dxx" %>

<%@ Register Assembly="DevExpress.XtraCharts.v18.1.Web, Version=18.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.XtraCharts.Web" TagPrefix="dxxui" %>
				...
				<tr>
					...
					<td style="vertical-align: top">
						...
						<table>
							...
							<tr>
								<td colspan="3"><dx:ASPxCheckBox ID="chkOpt_miss" runat="server" Text="Missing Data tables"  /></td>
							</tr>
							<tr>
								<td colspan="3"><dx:ASPxCheckBox ID="chkOpt_data" runat="server" Text="Stacked Data Table"  /></td>
							</tr>
						</table>
	...
	<dx:ASPxPanel ID="panelDescStats" runat="server" ClientInstanceName="panelDescStats" ClientVisible="false">
		<PanelCollection>
			<dx:PanelContent>
				...
				<dx:ASPxPivotGrid ID="pivotDescStats" runat="server" 
	...
	<br />
		...
		<PanelCollection>
			<dx:PanelContent>
				...
				<dx:ASPxPivotGrid ID="pivotMissing" runat="server" 
