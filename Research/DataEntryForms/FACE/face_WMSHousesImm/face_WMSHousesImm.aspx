<%@ Page language="c#" Inherits="face_WMSHousesImm.face_WMSHousesImm" CodeFile="face_WMSHousesImm.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>

<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" VerifiedField="verified" PrimaryKeyField="whi_pk"
							MeasureName="FACE WMS Houses Immediate" LookupTextBox1LabelText="FACE ID:" LookupTextBox2Visible="False"
							LookupField1="faceid" DatabaseTable="face_wmshousesimm" LookupField1DataType="TEXT" ShowScoreButton="True"
							StudyMeasID="476" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
						...
						<asp:Panel Runat="server" ID="mainPanel">
							...
							<TABLE class="grid">
								<TR>
									<TD class="heading" colSpan="3" height="21">Houses Immediate</TD>
								</TR>
								<TR>
									<TD colSpan="3">
