...
{
	/// <summary>
	/// Summary description for face_wais.
	/// </summary>
	public partial class face_wais : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.face_wais_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreWechslerIQ.Parameters["@studyid"].Value = 1010;
		...
		protected void face_wais_PreRender(object sender, System.EventArgs e)
		{
