...
namespace face_PsychHx
{
	/// <summary>
	/// Summary description for face_PsychHx.
	/// </summary>
	public partial class face_PsychHx : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.face_PsychHx_PreRender);

		}
		#endregion

		protected void face_PsychHx_PreRender(object sender, System.EventArgs e)
		{
