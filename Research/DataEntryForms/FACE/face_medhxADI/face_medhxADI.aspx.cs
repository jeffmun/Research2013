...
namespace face_medhxADI
{
	/// <summary>
	/// Summary description for face_medhxADI.
	/// </summary>
	public partial class face_medhxADI : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.face_medhxADI_PreRender);

		}
		#endregion

		protected void face_medhxADI_PreRender(object sender, System.EventArgs e)
		{
