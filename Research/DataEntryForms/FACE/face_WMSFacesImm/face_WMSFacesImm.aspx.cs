...
namespace face_WMSFacesImm
{
	/// <summary>
	/// Summary description for face_WMSFacesImm.
	/// </summary>
	public partial class face_WMSFacesImm : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.face_WMSFacesImm_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreWMSDetail.Parameters["@test"].Value = "FACES_IMM";
		...
		protected void face_WMSFacesImm_PreRender(object sender, System.EventArgs e)
		{
