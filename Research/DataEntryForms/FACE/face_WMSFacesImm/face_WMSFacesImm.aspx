<%@ Page language="c#" Inherits="face_WMSFacesImm.face_WMSFacesImm" CodeFile="face_WMSFacesImm.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>

<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" VerifiedField="verified" PrimaryKeyField="wfi_pk"
							MeasureName="FACE WMS Faces Immediate" LookupTextBox1LabelText="FACE ID:" LookupTextBox2Visible="False"
							LookupField1="faceid" DatabaseTable="face_wmsfacesimm" LookupField1DataType="TEXT" ShowScoreButton="True"
							StudyMeasID="380" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
									...
									<table class="grid">
										<tr>
											<td><def:datafieldcontrol id="wmsdob" runat="server" FieldDataType="DATE" IsInsertField="False" IsInsertValueRequired="False"
													...
													FieldTextBoxTabIndex="4" DatabaseField="wfidob" FieldLabelWidth="60px" FormatString="{0:d}" RenderReadOnlyAsDiv="True"></def:datafieldcontrol>
											</td>
										</tr>
										<tr>
											<td><def:datafieldcontrol id="wmsageyr" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
													...
													FieldTextBoxTabIndex="5" DatabaseField="wfiageyr" FieldLabelWidth="60px" RenderReadOnlyAsDiv="True"></def:datafieldcontrol>
											</td>
										</tr>
									</table>
								</td>
