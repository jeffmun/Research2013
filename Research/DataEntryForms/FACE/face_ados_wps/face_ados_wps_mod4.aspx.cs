...
namespace face_ados_wps
{
	/// <summary>
	/// Summary description for face_ados_wps_mod4.
	/// </summary>
	public partial class face_ados_wps_mod4 : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.face_ados_wps_mod4_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				sqlScoreADOS_WPS.Parameters["@studyid"].Value = 1010;
		...
		protected void face_ados_wps_mod4_PreRender(object sender, System.EventArgs e)
		{
