...
namespace face_WMSFacesDel
{
	/// <summary>
	/// Summary description for face_WMSFacesDel.
	/// </summary>
	public partial class face_WMSFacesDel : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.face_WMSFacesDel_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreWMSDetail.Parameters["@test"].Value = "FACES_DEL";
		...
		protected void face_WMSFacesDel_PreRender(object sender, System.EventArgs e)
		{
