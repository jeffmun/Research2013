...
<%@ Page language="c#" Inherits="face_WMSFacesDel.face_WMSFacesDel" CodeFile="face_WMSFacesDel.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" VerifiedField="verified" PrimaryKeyField="wfd_pk"
							MeasureName="FACE WMS Faces Delayed" LookupTextBox1LabelText="FACE ID:" LookupTextBox2Visible="False"
							LookupField1="faceid" DatabaseTable="face_wmsfacesdel" LookupField1DataType="TEXT" ShowScoreButton="True"
							StudyMeasID="381" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
									...
									<table class="grid">
										<tr>
											<td><def:datafieldcontrol id="wmsdob" runat="server" FieldDataType="DATE" IsInsertField="False" IsInsertValueRequired="False"
													...
													FieldTextBoxTabIndex="4" DatabaseField="wfddob" FieldLabelWidth="60px" FormatString="{0:d}" RenderReadOnlyAsDiv="True"></def:datafieldcontrol>
											</td>
										</tr>
										<tr>
											<td><def:datafieldcontrol id="wmsageyr" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
													...
													FieldTextBoxTabIndex="5" DatabaseField="wfdageyr" FieldLabelWidth="60px" RenderReadOnlyAsDiv="True"></def:datafieldcontrol>
											</td>
										</tr>
									</table>
								</td>
