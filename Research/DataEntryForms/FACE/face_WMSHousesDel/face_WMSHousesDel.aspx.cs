...
namespace face_WMSHousesDel
{
	/// <summary>
	/// Summary description for face_WMSHousesDel.
	/// </summary>
	public partial class face_WMSHousesDel : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.face_WMSHousesDel_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreWMSDetail.Parameters["@test"].Value = "HOUSES_DEL";
		...
		protected void face_WMSHousesDel_PreRender(object sender, System.EventArgs e)
		{
