<%@ Page language="c#" Inherits="fein_vine.fein_vine" CodeFile="fein_vine.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="id" VerifiedField="verified"
							PrimaryKeyField="identityID" MeasureName="FEIN Vineland" LookupTextBox2Visible="True" LookupTextBox1LabelText="FEIN ID:"
							DatabaseTable="fein_vine" LookupField1DataType="TEXT" ShowScoreButton="True" StudyMeasID="546" LookupTextBox2LabelText="Timepoint(1 or 2):"
							LookupField2="indexnum" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
								<td style="vertical-align:top">
									<table class="layout" id="table_insert">
										<tr>
											<td><def:datafieldcontrol id="ID" runat="server" FieldLabelWidth="80px" FieldTextBoxWidth="100px" FieldDataType="TEXT"
													IsInsertField="True" IsInsertValueRequired="True" IsEntryField="False" IsEntryValueRequired="False"
													IsReadOnly="False" IsDoubleEntryField="False" FieldLabelText="FEIN ID" FieldTextBoxTabIndex="1" DatabaseField="ID"></def:datafieldcontrol></td>
										</tr>
										<tr>
											<td><def:datafieldcontrol id="indexnum" runat="server" FieldLabelWidth="80px" FieldTextBoxWidth="100px" FieldDataType="INT"
													IsInsertField="True" IsInsertValueRequired="True" IsEntryField="False" IsEntryValueRequired="False"
													IsReadOnly="False" IsDoubleEntryField="False" FieldLabelText="Timepoint(1 or 2)" FieldTextBoxTabIndex="1"
													DatabaseField="indexnum" ValidList="1,2"></def:datafieldcontrol></td>
										</tr>
										<tr>
										...
										<tr>
											<td><def:datafieldcontrol id="DOB" runat="server" FieldLabelWidth="80px" FieldDataType="DATE" IsInsertField="True"
													IsInsertValueRequired="True" IsEntryField="True" IsEntryValueRequired="True" IsReadOnly="False" IsDoubleEntryField="True"
													FieldLabelText="DOB:" FieldTextBoxTabIndex="4" DatabaseField="DOB" FormatString="{0:d}" RenderReadOnlyAsDiv="False"
													FieldTextBoxWidth="100px"></def:datafieldcontrol></td>
										</tr>
									</table>
								</td>
								<td>
						...
						<asp:panel id="mainPanel" runat="server">
								...
								<TR>
									...
									<TD style="vertical-align:top">
										...
										<def:datafieldcontrol id="VineCmnt" runat="server" DatabaseField="VineCmnt" FieldTextBoxTabIndex="18"
											...
											ShowFieldLabel="False" FieldTextBoxMaxLength="500" FieldTextBoxTextMode="MultiLine" FieldTextBoxHeight="150px"></def:datafieldcontrol></TD>
								</TR>
							</TABLE>
							<def:datafieldcontrol id="ScoreMsg" runat="server" DatabaseField="ScoreMsg" FieldTextBoxTabIndex="87"
								...
								RenderReadOnlyAsDiv="True" FieldTextBoxMaxLength="500"></def:datafieldcontrol>
							<BR>
							<TABLE class="layout" id="table6">
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="scored" runat="server" DatabaseField="scored" FieldTextBoxTabIndex="92" FieldLabelText="scored"
											IsDoubleEntryField="False" IsReadOnly="True" IsEntryValueRequired="False" IsEntryField="False" IsInsertValueRequired="False"
											IsInsertField="False" FieldDataType="TEXT" FieldLabelWidth="80px" RenderReadOnlyAsDiv="True"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
										<def:datafieldcontrol id="scoredBy" runat="server" DatabaseField="scoredBy" FieldTextBoxTabIndex="92"
											FieldLabelText="scoredBy" IsDoubleEntryField="False" IsReadOnly="True" IsEntryValueRequired="False"
											IsEntryField="False" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="TEXT" FieldLabelWidth="80px"
											RenderReadOnlyAsDiv="True" DESIGNTIMEDRAGDROP="85"></def:datafieldcontrol></TD>
								</TR>
							</TABLE>
