...
{
	/// <summary>
	/// Summary description for fein_vine.
	/// </summary>
	public partial class fein_vine : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.fein_vine_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreVineland.Parameters["@studyid"].Value = 1014;
		...
		protected void fein_vine_PreRender(object sender, System.EventArgs e)
		{
