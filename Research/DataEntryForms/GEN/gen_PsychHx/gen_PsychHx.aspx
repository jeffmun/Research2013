<%@ Page language="c#" Inherits="gen_PsychHx.gen_PsychHx" CodeFile="gen_PsychHx.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1DataType="INT" VerifiedField="verified"
							PrimaryKeyField="phx_pk" MeasureName="GEN Psych Hx" LookupTextBox1LabelText="GEN ID:" LookupTextBox2Visible="False"
							LookupField1="ID" DatabaseTable="ALL_psychhx" StudyMeasID="133"></def:dataentrycontroller>
						<table class="layout" id="table_insert">
							<tr>
								<td><def:datafieldcontrol id="ID" runat="server" FieldDataType="INT" IsInsertField="True" IsInsertValueRequired="True"
						...
						<asp:Panel Runat="server" ID="mainPanel">
							<TABLE class="grid" id="table_entry">
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="phx571" runat="server" FieldTextBoxWidth="50px" DatabaseField="phx571" FieldTextBoxTabIndex="17"
											FieldLabelText="571. Depression (# of episodes) Enter 888 for whole life" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" RegEx="^([0-9]|[1-9][0-9]|888|999)$" RegExDescription="Value must be between 0 and 99, 888, or 999"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
										<def:datafieldcontrol id="phx572" runat="server" FieldTextBoxWidth="50px" DatabaseField="phx572" FieldTextBoxTabIndex="18"
											FieldLabelText="572. Depression (# of episodes since 2nd disabled child)" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" RegEx="^([0-9]|[1-9][0-9]|888|999)$" RegExDescription="Value must be between 0 and 99, 888, or 999"></def:datafieldcontrol></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="phx57a1" runat="server" FieldTextBoxWidth="50px" DatabaseField="phx57a1" FieldTextBoxTabIndex="20"
											FieldLabelText="57a1. Anxiety (# of months of sxs) Enter 888 for whole life" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" RegEx="^([0-9]|[1-9][0-9]|[1-2][0-9][0-9]|888|999)$" RegExDescription="Value must be between 0 and 299, 888, or 999"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
										<def:datafieldcontrol id="phx57a2" runat="server" FieldTextBoxWidth="50px" DatabaseField="phx57a2" FieldTextBoxTabIndex="21"
											FieldLabelText="57a2. Anxiety (# of months of sxs since 2nd disabled child)" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" RegEx="^([0-9]|[1-9][0-9]|[1-2][0-9][0-9]|888|999)$" RegExDescription="Value must be between 0 and 299, 888, or 999"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
										<def:datafieldcontrol id="phx58" runat="server" FieldTextBoxWidth="50px" DatabaseField="phx58" FieldTextBoxTabIndex="22"
											FieldLabelText="58. Affective disorder summary" IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True"
											IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-9][0-9]|[1-2][0-9][0-9]|999)$"
											RegExDescription="Value must be between 0 and 299 or 999"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
