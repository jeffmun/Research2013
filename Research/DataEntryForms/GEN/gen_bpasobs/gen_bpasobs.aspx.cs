...
namespace gen_bpasobs
{
	/// <summary>
	/// Summary description for gen_bpasobs.
	/// </summary>
	public partial class gen_bpasobs : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.gen_bpasobs_PreRender);

		}
		#endregion

		protected void gen_bpasobs_PreRender(object sender, System.EventArgs e)
		{
		...
		private void DataEntryController1_DoReliability(object sender, System.EventArgs e)
		{
			try 
			{
				...
				sqlReliabilityAdd.Parameters["@orig_studymeasid"].Value = 136;
