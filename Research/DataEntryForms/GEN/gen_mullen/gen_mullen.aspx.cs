...
namespace gen_mullen
{
	/// <summary>
	/// Summary description for gen_mullen.
	/// </summary>
	public partial class gen_mullen : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.gen_mullen_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreMullen.Parameters["@studyid"].Value = 4;
		...
		protected void gen_mullen_PreRender(object sender, System.EventArgs e)
		{
