<%@ Page language="c#" Inherits="gen_vine.gen_vine" CodeFile="gen_vine.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="id" VerifiedField="verified"
							PrimaryKeyField="vine_pk" MeasureName="GEN Vineland" LookupTextBox2Visible="False" LookupTextBox1LabelText="GEN ID:"
							DatabaseTable="gen_vine" LookupField1DataType="INT" ShowScoreButton="True" StudyMeasID="147" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
									...
									<table class="layout" id="table_insert">
										<tr>
											<td><def:datafieldcontrol id="ID" runat="server" FieldLabelWidth="80px" FieldTextBoxWidth="100px" FieldDataType="INT"
													...
													IsReadOnly="False" IsDoubleEntryField="False" FieldLabelText="GEN ID" FieldTextBoxTabIndex="1" DatabaseField="ID"></def:datafieldcontrol></td>
										</tr>
										<tr>
								...
								<TR>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Crecraw" runat="server" DatabaseField="Crecraw" FieldTextBoxTabIndex="6" FieldLabelText="Crecraw"
														...
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-26 or 999"
														RegEx="^([0-9]|1[0-9]|2[0-6]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Cexpraw" runat="server" DatabaseField="Cexpraw" FieldTextBoxTabIndex="7" FieldLabelText="Cexpraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-62 or 999"
														RegEx="^([0-9]|[1-5][0-9]|6[0-2]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Cwriraw" runat="server" DatabaseField="Cwriraw" FieldTextBoxTabIndex="8" FieldLabelText="Cwriraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-46 or 999"
														RegEx="^([0-9]|[1-3][0-9]|4[0-6]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Dperraw" runat="server" DatabaseField="Dperraw" FieldTextBoxTabIndex="9" FieldLabelText="Dperraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-78 or 999"
														RegEx="^([0-9]|[1-6][0-9]|7[0-8]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Ddomraw" runat="server" DatabaseField="Ddomraw" FieldTextBoxTabIndex="10" FieldLabelText="Ddomraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-42 or 999"
														RegEx="^([0-9]|[1-3][0-9]|4[0-2]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Dcomraw" runat="server" DatabaseField="Dcomraw" FieldTextBoxTabIndex="11" FieldLabelText="Dcomraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-64 or 999"
														RegEx="^([0-9]|[1-5][0-9]|6[0-4]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Sintrraw" runat="server" DatabaseField="Sintrraw" FieldTextBoxTabIndex="12"
														...
														ShowFieldLabel="False" RegExDescription="Must be 0-56 or 999" RegEx="^([0-9]|[1-4][0-9]|5[0-6]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Splaraw" runat="server" DatabaseField="Splaraw" FieldTextBoxTabIndex="13" FieldLabelText="Splaraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-40 or 999"
														RegEx="^([0-9]|[1-3][0-9]|40|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Scopraw" runat="server" DatabaseField="Scopraw" FieldTextBoxTabIndex="14" FieldLabelText="Scopraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-36 or 999"
														RegEx="^([0-9]|[1-2][0-9]|3[0-6]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Mfinraw" runat="server" DatabaseField="Mfinraw" FieldTextBoxTabIndex="16" FieldLabelText="Mfinraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="40px" ShowFieldLabel="False" RegExDescription="Must be 0-32 or 999"
														RegEx="^([0-9]|[1-2][0-9]|3[0-2]|999)$"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
									...
									<TD style="vertical-align:top">
										...
										<def:datafieldcontrol id="VineCmnt" runat="server" DatabaseField="VineCmnt" FieldTextBoxTabIndex="18"
											...
											ShowFieldLabel="False" FieldTextBoxHeight="150px" FieldTextBoxTextMode="MultiLine"></def:datafieldcontrol></TD>
								</TR>
							</TABLE>
