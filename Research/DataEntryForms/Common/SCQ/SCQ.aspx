...
<%@ Page language="c#" MasterPageFile="~/UWAC.master"  Title="SCQ Data Entry" %>
...
<table border="1" cellpadding="0" cellspacing="0" style="color: #0000FF">
    ...
    <tr>
        ...
        Lifetime
            ...
            <def:datafieldcontrol runat="server" id="SCQscrmsg" DatabaseField="SCQscrmsg"  IsEntryField="false" IsReadOnly="true" FieldLabelWidth="350px" FieldTextBoxWidth="30px"   RenderReadOnlyAsDiv="true"></def:datafieldcontrol>
