...
namespace KTDissDataEntryForms.kt_cts3
{
	/// <summary>
	/// Summary description for kt_cts3.
	/// </summary>
	public partial class kt_cts3 : System.Web.UI.Page
	{
		protected System.Data.SqlClient.SqlConnection sqlDataConnection;
		protected System.Data.SqlClient.SqlCommand sqlScoreCTS_MCTQ;
		...
		{    
			...
			this.sqlScoreCTS_MCTQ = new System.Data.SqlClient.SqlCommand();
			...
			// sqlScoreCTS_MCTQ
			// 
			this.sqlScoreCTS_MCTQ.CommandText = "dbo.[spScoreCTS_MCTQ]";
			this.sqlScoreCTS_MCTQ.CommandType = System.Data.CommandType.StoredProcedure;
			this.sqlScoreCTS_MCTQ.Connection = this.sqlDataConnection;
			this.sqlScoreCTS_MCTQ.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(0)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlScoreCTS_MCTQ.Parameters.Add(new System.Data.SqlClient.SqlParameter("@cts_pk", System.Data.SqlDbType.Int, 4));
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreCTS_MCTQ.Parameters["@cts_pk"].Value =  DataEntryController1.PrimaryKeyVal;


				this.sqlDataConnection.Open();

				// this statement can throw an SqlException if any errors occur in spScoreMullen
				this.sqlScoreCTS_MCTQ.ExecuteNonQuery();
