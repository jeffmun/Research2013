		...
		case "<%= EDIsotB.ClientID %>":
			...
			break;
						...
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="all_edi" LookupField1="id"
							...
							AllowedStudyMeasures="343,557,568,1688,1727,1772,1812,1830,1856,1873,1874,1875,2038,2670,2745,2761,2774,2785,2799,2811"
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="EDI01" runat="server" FieldLabelWidth="400px" FieldTextBoxWidth="30px" DatabaseField="EDI01"
											...
											FieldDataType="INT" FieldTextBoxTextDefault="9" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
										<def:datafieldcontrol id="EDI02" runat="server" FieldLabelWidth="400px" FieldTextBoxWidth="30px" DatabaseField="EDI02"
											...
											IsInsertField="False" FieldDataType="INT" FieldTextBoxTextDefault="9" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="EDI08" runat="server" FieldLabelWidth="400px" FieldTextBoxWidth="30px" DatabaseField="EDI08"
											...
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldTextBoxTextDefault="9" ValidList="0,1,2,9"></def:datafieldcontrol><BR>
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="EDIinj" runat="server" FieldLabelWidth="250px" FieldTextBoxWidth="30px" DatabaseField="EDIinj"
											...
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldTextBoxTextDefault="9" ValidList="0,1,2,9" ShowFieldLabel="False" CallOnBlur="edi_onBlur" DESIGNTIMEDRAGDROP="1398"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="EDIinj1" runat="server" FieldTextBoxWidth="30px" DatabaseField="EDIinj1" FieldTextBoxTabIndex="121"
											...
											IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" FieldTextBoxTextDefault="9" ValidList="0,1,8,9"
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="EDIdear" runat="server" FieldLabelWidth="250px" FieldTextBoxWidth="30px" DatabaseField="EDIdear"
											...
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldTextBoxTextDefault="9" ValidList="0,1,2,9" ShowFieldLabel="False" CallOnBlur="edi_onBlur"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="EDIsotA" runat="server" FieldLabelWidth="250px" FieldTextBoxWidth="30px" DatabaseField="EDIsotA"
											...
											IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" FieldTextBoxTextDefault="9" ValidList="0,1,2,9"
