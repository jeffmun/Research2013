...
<%@ Page language="c#" MasterPageFile="~/UWAC.master"  Title="SRS_Parent Data Entry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">

<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="ALL_SRS_Parent" >
...
<div class="collection">
  <div class="main"><def:datafieldcontrol runat="server" id="RelChild" DatabaseField="RelChild" FieldLabelText="Relationship to Child" IsInsertField="true"  FieldLabelWidth="300px " FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
