...
<%@ Page language="c#" MasterPageFile="~/UWAC.master"  Title="MIND_IntHx v2 Data Entry" %>
...
<style>
  ...
  .smallfont {font-size: smallest}
</style>
<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="ALL_MIND_IntHx_vers2" PrimaryKeyField="mindinthxv2_pk" >
...
<table cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td>
      ...
      <def:datafieldcontrol runat="server" id="IHDateIn" DatabaseField="IHDateIn" FieldLabelText="Interview Date" IsInsertField="true"  FieldLabelWidth="100px" FieldTextBoxWidth="75px" FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="next">
...
<table cellpadding="1" cellspacing="0" border="1">
  ...
  <tr>
    ...
    1) ABA/intensive early intervention<br/>
2) Occupational therapy (OT)<br/>
3) Physical therapy (PT)<br/>
4) Speech therapy<br/>
5) Counseling/ psych services for child<br/>
6) Play therapy<br/>
7) Music therapy<br/>
...
9) TEACCH<br/>
10) Greenspan/FT/Dev play therapy (Hanen, RDI)<br/>
11) <b>**</b>SonRise or other location specific training<br/>
12) <b>**</b>Social skills training<br/>
13) <b>**</b>Special education<br/>
14) <b>**</b>Parent-Coaching/Training<br/>
15) <b>**</b>Parent-Child socialization/support<br/>
16) <b>**</b>Parent-Counseling/Psychological services<br/>
    </td>
    <td class="key" width="33%" style="vertical-align:top">
17) <b>**</b>Parent-Child Recreation<br/>
18) Parenting class/seminar<br/>
19) <b>**</b>Recreational Sports/Leisure Activities<br/>
20) <b>**</b>Typical class<br/>
21) <b>**</b>Home based program/lessons (not ABA)<br/>
22) <b>**</b>Integrated/Blended class<br/>
23) <b>**</b>Home School<br/>
24) <b>**</b>Biomedical<br/>
25) <b>**</b>Nutritional<br/>
<br/><b>** Code changed from earlier version. Use these and not the one on the printed form.</b>
    </td>
  </tr>
</table>
    ...
    <td class="key" style="font-size:x-small"  >
      <!-- Frequency or Dose Units -->
1 = hrs/day<br/>
2 = hrs/month<br/>
3 = hrs/year<br/>
...
11 = hrs/yr
  ...
  <tr>
    <td>
      Type of Intervention<br /> <b>#1-5</b>
    </td>
    <td>
  ...
  <tr> <!-- A Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHADateBe" DatabaseField="IHADateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHADateEn" DatabaseField="IHADateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHA6Value" DatabaseField="IHA6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- B Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHBDateBe" DatabaseField="IHBDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHBDateEn" DatabaseField="IHBDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHB6Value" DatabaseField="IHB6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- C Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHCDateBe" DatabaseField="IHCDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHCDateEn" DatabaseField="IHCDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHC6Value" DatabaseField="IHC6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- D Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHDDateBe" DatabaseField="IHDDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHDDateEn" DatabaseField="IHDDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHD6Value" DatabaseField="IHD6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- E Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHEDateBe" DatabaseField="IHEDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHEDateEn" DatabaseField="IHEDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHE6Value" DatabaseField="IHE6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr>
    <td>
      Type of Intervention<br /> <b>#6-10</b>
    </td>
    <td>
      Name of School/Service Provider
    </td>
...
<%--  # 6 - 10 --%>
  <tr> <!-- F Group  6-10  -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHFDateBe" DatabaseField="IHFDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHFDateEn" DatabaseField="IHFDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHF6Value" DatabaseField="IHF6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- G Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHGDateBe" DatabaseField="IHGDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHGDateEn" DatabaseField="IHGDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHG6Value" DatabaseField="IHG6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- H Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHHDateBe" DatabaseField="IHHDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHHDateEn" DatabaseField="IHHDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHH6Value" DatabaseField="IHH6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- I Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHIDateBe" DatabaseField="IHIDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHIDateEn" DatabaseField="IHIDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHI6Value" DatabaseField="IHI6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- J Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHJDateBe" DatabaseField="IHJDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHJDateEn" DatabaseField="IHJDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHJ6Value" DatabaseField="IHJ6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
...
10 = times/yr
  ...
  <tr>
    <td>
      Type of Intervention<br /> <b>#11-15</b>
    </td>
    <td>
      Name of School/Service Provider
    </td>
...
<%--  #11 - 15 --%>
  <tr> <!-- K Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHKDateBe" DatabaseField="IHKDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHKDateEn" DatabaseField="IHKDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHK6Value" DatabaseField="IHK6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- L Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHLDateBe" DatabaseField="IHLDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHLDateEn" DatabaseField="IHLDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHL6Value" DatabaseField="IHL6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- M Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHMDateBe" DatabaseField="IHMDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHMDateEn" DatabaseField="IHMDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHM6Value" DatabaseField="IHM6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- N Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHNDateBe" DatabaseField="IHNDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHNDateEn" DatabaseField="IHNDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHN6Value" DatabaseField="IHN6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- O Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHODateBe" DatabaseField="IHODateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHODateEn" DatabaseField="IHODateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHO6Value" DatabaseField="IHO6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr>
    <td>
      Type of Intervention<br /> <b>#16-20</b>
    </td>
    <td>
      Name of School/Service Provider
    </td>
  ...
  <tr> <!-- P Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHPDateBe" DatabaseField="IHPDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHPDateEn" DatabaseField="IHPDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHP6Value" DatabaseField="IHP6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- Q Group -->
    ...
    <td class="odd">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHQDateBe" DatabaseField="IHQDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHQDateEn" DatabaseField="IHQDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHQ6Value" DatabaseField="IHQ6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- R Group -->
    ...
    <td class="even">
      <!-- Date Began -->
      <def:datafieldcontrol runat="server" id="IHRDateBe" DatabaseField="IHRDateBe"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Date Ended -->
      <def:datafieldcontrol runat="server" id="IHRDateEn" DatabaseField="IHRDateEn"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="75px " FormatString="{0:d}" ></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHR6Value" DatabaseField="IHR6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- S Group -->
    ...
    <td class="odd">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHS6Value" DatabaseField="IHS6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="odd">
      <!-- Frequency or Dose Units -->
  ...
  <tr> <!-- T Group -->
    ...
    <td class="even">
      <!-- Frequency or Dose Amount -->
      <def:datafieldcontrol runat="server" id="IHT6Value" DatabaseField="IHT6Value"  IsEntryField="true" IsDoubleEntryField="true"  FieldTextBoxWidth="30px "></def:datafieldcontrol>
    </td>
    <td class="even">
      <!-- Frequency or Dose Units -->
