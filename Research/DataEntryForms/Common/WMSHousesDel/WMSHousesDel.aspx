...
<%@ Page Language="C#" MasterPageFile="~/UWAC.master" AutoEventWireup="true" CodeFile="WMSHousesDel.aspx.cs" Inherits="DataEntryForms_Common_WMSHousesDel_WMSHousesDel" Title="Untitled Page" %>
...
<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1DataType="TEXT" ShowScoreButton="True"
	VerifiedField="verified" PrimaryKeyField="whd_pk" MeasureName="WMS Houses Delayed" LookupTextBox1LabelText="Subject ID:"
	LookupTextBox2Visible="False" LookupField1="id" DatabaseTable="all_wmshousesdel" AllowedStudyMeasures="475,919,2252" OnDoScore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
