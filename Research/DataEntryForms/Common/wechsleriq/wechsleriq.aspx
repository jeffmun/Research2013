<%@ Page language="c#" Inherits="common_wechsleriq.gen_wechsleriq" CodeFile="wechsleriq.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" ShowScoreButton="True" LookupField1DataType="TEXT"
							DatabaseTable="ALL_WechslerIQ" LookupTextBox1LabelText="Subject ID:" LookupTextBox2Visible="False" MeasureName="Wechsler IQ"
							PrimaryKeyField="IQnum" VerifiedField="verified" LookupField1="id" LastScoredDateField="scored" LastUpdatedDateField="updated" ondocreatenew="DataEntryController1_DoCreateNew"
							AllowedStudyMeasures="126,223,289,378,671,1975,2664" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table>
							<tr>
								<td style="vertical-align:top">
									<table class="tblinsert" id="layout">
										<tr>
											<td>
												ID</td>
											<td><def:datafieldcontrol id="INDID" runat="server" DatabaseField="ID" FieldTextBoxTabIndex="2" FieldLabelText="ID"
													IsDoubleEntryField="False" IsReadOnly="False" IsEntryValueRequired="False" IsEntryField="False" IsInsertValueRequired="True"
													IsInsertField="True" FieldDataType="TEXT" FieldTextBoxWidth="100px" ShowFieldLabel="False" FieldLabelWidth="100px"></def:datafieldcontrol></td>
										</tr>
										<tr>
											<td>IQ Test</td>
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="IQcmnt" tabIndex="21" runat="server" FieldLabelWidth="150px" FieldTextBoxWidth="200px"
											...
											DatabaseField="IQcmnt" FieldTextBoxHeight="80px" FieldTextBoxTextMode="MultiLine"></def:datafieldcontrol></TD>
								</TR>
							</TABLE>
							<BR>
