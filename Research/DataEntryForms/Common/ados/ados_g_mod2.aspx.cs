...
{
	/// <summary>
	/// Summary description for ados_g_mod2.
	/// </summary>
	public partial class ados_g_mod2 : System.Web.UI.Page
	{
		...
		{    
			...
			this.sqlInsert.CommandText = "INSERT INTO gen_ados (indid, ADOSdate, ADOSclin, ADOSmod, ADOSver, verified) VALU" +
				"ES (@indid, @ADOSdate, @ADOSclin, 2, \'G\', @verified); SELECT * FROM gen_ados WHE" +
				"RE ados_pk = @@IDENTITY;";
