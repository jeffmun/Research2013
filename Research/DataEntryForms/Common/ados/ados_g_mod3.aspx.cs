...
{
	/// <summary>
	/// Summary description for ados_g_mod3.
	/// </summary>
	public partial class ados_g_mod3 : System.Web.UI.Page
	{
		...
		protected System.Data.SqlClient.SqlCommand sqlScoreADOS_G;
		...
		{    
			...
			this.sqlScoreADOS_G = new System.Data.SqlClient.SqlCommand();
			...
			// sqlLookup
			// 
			this.sqlLookup.CommandText = "SELECT GEN_ADOS.* FROM GEN_ADOS WHERE (ADOSmod = 3) AND (indid = @indid) AND (ADO" +
				"Sver = \'G\')";
			...
			this.sqlUpdate.Parameters.Add(new System.Data.SqlClient.SqlParameter("@ADOS29", System.Data.SqlDbType.SmallInt, 2, "ADOS29"));
			this.sqlUpdate.Parameters.Add(new System.Data.SqlClient.SqlParameter("@ADOS30", System.Data.SqlDbType.SmallInt, 2, "ADOS30"));
			...
			this.sqlInsert.CommandText = "INSERT INTO gen_ados (indid, ADOSdate, ADOSclin, ADOSmod, ADOSver, verified) VALU" +
				"ES (@indid, @ADOSdate, @ADOSclin, 3, \'G\', @verified); SELECT * FROM gen_ados WHE" +
				"RE ados_pk = @@IDENTITY;";
			...
			// sqlScoreADOS_G
			// 
			this.sqlScoreADOS_G.CommandText = "dbo.[spScoreADOS_G]";
			this.sqlScoreADOS_G.CommandType = System.Data.CommandType.StoredProcedure;
			this.sqlScoreADOS_G.Connection = this.sqlDataConnection;
			this.sqlScoreADOS_G.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(0)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlScoreADOS_G.Parameters.Add(new System.Data.SqlClient.SqlParameter("@ados_pk", System.Data.SqlDbType.Int, 4));
			this.sqlScoreADOS_G.Parameters.Add(new System.Data.SqlClient.SqlParameter("@studyid", System.Data.SqlDbType.Int, 4));
			// 
			// sqlScoreADOSGeneric
			// 
