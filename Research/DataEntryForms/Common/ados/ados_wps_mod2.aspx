<%@ Page language="c#" Inherits="gen_ados_wps.ados_wps_mod2" CodeFile="ados_wps_mod2.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						...
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="all_ados" LookupField1="id"
							LookupTextBox2Visible="True" LookupTextBox1LabelText="Subject ID:" MeasureName="ADOS-WPS Module 2" PrimaryKeyField="ados_pk"
						...
						<table>
							<tr>
									...
									<table id="table_insert" class="layout">
										...
										<tr>
											<td><def:datafieldcontrol id="Datafieldcontrol1" runat="server" DatabaseField="ADOSmod" FieldTextBoxTabIndex="54"
													...
													FieldTextBoxCssClass="hideme" FieldTextBoxTextDefault="2"></def:datafieldcontrol></td>
										</tr>
										<tr>
								...
								<td>
									<table class="layout">
										<tr> <span style="text-decoration: underline">Original WPS Algorithm </span><br />
								...
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS01" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS01"
											FieldTextBoxTabIndex="6" FieldLabelText="A1. Overall level of lang" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,7,9"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS15" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS15"
											FieldTextBoxTabIndex="20" FieldLabelText="B7. Response to joint attention" IsDoubleEntryField="True"
								...
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS02" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS02"
											FieldTextBoxTabIndex="7" FieldLabelText="A2. Amount of social overtures" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,7,9"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS16" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS16"
											FieldTextBoxTabIndex="21" FieldLabelText="B8. Quality of social overtures" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS03" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS03"
											FieldTextBoxTabIndex="8" FieldLabelText="A3. Speech abnormalities" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
									...
									<TD>
										<def:datafieldcontrol id="ADOS17" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS17"
											FieldTextBoxTabIndex="22" FieldLabelText="B9. Quality of Social Response" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS04" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS04"
											FieldTextBoxTabIndex="9" FieldLabelText="A4. Echolalia" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS18" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS18"
											FieldTextBoxTabIndex="23" FieldLabelText="B10.  Amount of Reciprocal Social Communication" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS19" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS19"
											FieldTextBoxTabIndex="24" FieldLabelText="B11.  Quality of rapport" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS06" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS06"
											FieldTextBoxTabIndex="11" FieldLabelText="A6. Conversation" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS20" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS20"
											FieldTextBoxTabIndex="25" FieldLabelText="C1.  Functional play w/ obj" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS21" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS21"
											FieldTextBoxTabIndex="26" FieldLabelText="C2. Imagination/Creativity" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS08" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS08"
											FieldTextBoxTabIndex="13" FieldLabelText="A8.  Descriptive Gestures" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
									...
									<TD>
										<def:datafieldcontrol id="ADOS22" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS22"
											FieldTextBoxTabIndex="27" FieldLabelText="D1. Unusual sensory interest" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS23" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS23"
											FieldTextBoxTabIndex="28" FieldLabelText="D2. Hand and finger mannerisms" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS10" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS10"
											FieldTextBoxTabIndex="15" FieldLabelText="B2. Facial expressions directed to others" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS24" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS24"
											FieldTextBoxTabIndex="29" FieldLabelText="D3.  Self-Injurious behavior" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS11" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS11"
											FieldTextBoxTabIndex="16" FieldLabelText="B3. Shared enjoyment" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
									...
									<TD>
										<def:datafieldcontrol id="ADOS25" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS25"
											FieldTextBoxTabIndex="30" FieldLabelText="D4. Repetitive interest/ stereotyped behav" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS12" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS12"
											FieldTextBoxTabIndex="17" FieldLabelText="B4. Response to name" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS13" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS13"
											FieldTextBoxTabIndex="18" FieldLabelText="B5. Showing" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									<TD width="330">
										<def:datafieldcontrol id="ADOS14" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS14"
											FieldTextBoxTabIndex="19" FieldLabelText="B6. Spontaneous Initiation of joint attn" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
									<TD>
