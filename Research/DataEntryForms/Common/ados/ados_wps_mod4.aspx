...
<%@ Page language="c#" Inherits="gen_ados_wps.ados_wps_mod4" CodeFile="ados_wps_mod4.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						...
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="all_ados" LookupField1="id"
							LookupTextBox2Visible="True" LookupTextBox1LabelText="Subject ID:" MeasureName="ADOS-WPS Module 4" PrimaryKeyField="ados_pk"
						...
						<h3>ADOS WPS Module 4</h3>
                                
                                <i><b>Note: No new scoring algorithm for Module 4 was supplied in the 2007 update.</b>
    <br/>
    Thus, we have implemented the Module 3 scoring rules for the new algorithm variables (per a suggestion from Cathy Lord, personal communication).<br/> 
    As a result, the "ADOS diagnosis" variable (based on the original WPS algorithm) and "ADOS classification" variable (based on applying Mod 3, 2007 rules) 
    may yield different results. The severity score 
    based on Module 3 scoring rules for the oldest age group is provided. This value
    is stored in the "ADOSSevScrExt" variable. This is the ADOS severity score
    extended value, which is used for cases that do not directly fit into the severity
    score framework, but for whom severity scores are calculated by applying the
    rules of an older or younger group.
    
    <br/> <br/> When using the "ADOS classification"
    or "ADOS severity score extended" variables in publication/presentation please specify
    <br/> this procedure as these variables are not officially part of the ADOS WPS
    Module 4. (contact Jeff Munson with questions, July 19, 2011) <br/> 
    </i>
    <br/>
    <h5>Items in bold
    reflect algorithm items from the original WPS scoring rules. </h5>
						<table>
							<tr>
								...
								<td>
									...
									<tr><td  style="width: 350px" style="vertical-align:top">
									<span style="text-decoration: underline">
                                    Original WPS Algorithm<br /></span>
										
										<def:datafieldcontrol id="ADOScom" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
										...
										<def:datafieldcontrol id="ADOSsoc" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
											...
											<def:datafieldcontrol id="ADOStot" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
										...
										<def:datafieldcontrol id="ADOSCtot" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
											...
											<def:datafieldcontrol id="ADOSDtot" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
											...
											<def:datafieldcontrol id="ADOSdx" runat="server" FieldDataType="TEXT" IsInsertField="False" IsInsertValueRequired="False"
			...
			<td style="width: 400px" style="vertical-align:top">
                                    ...
                                    <def:DataFieldControl ID="Datafieldcontrol6" runat="server" DatabaseField="ADOSclass"
                                        ...
                                        IsInsertField="False" IsInsertValueRequired="False" IsReadOnly="True" RenderReadOnlyAsDiv="True" />
                                        	<br/>
										<br/>
										<def:datafieldcontrol id="ADOSsevscr" runat="server" FieldDataType="TEXT" IsInsertField="False" IsInsertValueRequired="False"
										     IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="True" IsDoubleEntryField="False" FieldLabelText="ADOS severity score:"
													FieldTextBoxTabIndex="43" DatabaseField="ADOSsevscr" FieldLabelWidth="200px" RenderReadOnlyAsDiv="True"></def:datafieldcontrol>
										<def:datafieldcontrol id="ADOSsevscrext" runat="server" FieldDataType="TEXT" IsInsertField="False" IsInsertValueRequired="False"
										     IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="True" IsDoubleEntryField="False" FieldLabelText="ADOS severity score (extended):"
													FieldTextBoxTabIndex="43" DatabaseField="ADOSsevscrext" FieldLabelWidth="200px" RenderReadOnlyAsDiv="True"></def:datafieldcontrol>
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS16" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS16"
											FieldTextBoxTabIndex="21" FieldLabelText="B6. Empathy" IsDoubleEntryField="True" IsReadOnly="False"
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS17" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS17"
											FieldTextBoxTabIndex="22" FieldLabelText="B7. Insight" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS18" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS18"
											FieldTextBoxTabIndex="23" FieldLabelText="B8. Responsibility" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS19" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS19"
											FieldTextBoxTabIndex="24" FieldLabelText="B9. Quality of social overtures" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS20" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS20"
											FieldTextBoxTabIndex="25" FieldLabelText="B10.  Quality of social response" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS21" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS21"
											FieldTextBoxTabIndex="26" FieldLabelText="B11. Amt of reciprocal social communication" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS22" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS22"
											FieldTextBoxTabIndex="27" FieldLabelText="B12. Overall quality of rapport" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS23" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS23"
											FieldTextBoxTabIndex="28" FieldLabelText="C1. Imagination/creativity" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="327">
										<def:datafieldcontrol id="ADOS09" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS09"
											...
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,8"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS24" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS24"
											FieldTextBoxTabIndex="29" FieldLabelText="D1. Unusual sensory interest" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS25" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS25"
											FieldTextBoxTabIndex="30" FieldLabelText="D2. Hand and finger mannerisms" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS26" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS26"
											FieldTextBoxTabIndex="31" FieldLabelText="D3. Self-Injurious behavior" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS27" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS27"
											FieldTextBoxTabIndex="32" FieldLabelText="D4. Excessive interest to unusual/specific topics" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="ADOS28" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS28"
											FieldTextBoxTabIndex="33" FieldLabelText="D5. Compulsions or rituals" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="327">
										<def:datafieldcontrol id="ADOS14" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS14"
											FieldTextBoxTabIndex="19" FieldLabelText="B4. Shared enjoyment" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
									...
									<TD>
										<def:datafieldcontrol id="ADOS29" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS29"
											FieldTextBoxTabIndex="34" FieldLabelText="E1. Overactivity" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									<TD width="327">
										<def:datafieldcontrol id="ADOS15" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS15"
											FieldTextBoxTabIndex="20" FieldLabelText="B5. Communication of own affect" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS30" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS30"
											FieldTextBoxTabIndex="35" FieldLabelText="E2. Tantrums, aggress, neg beh." IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD width="327"></TD>
									<TD>
										<def:datafieldcontrol id="ADOS31" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS31"
											FieldTextBoxTabIndex="36" FieldLabelText="E3.  Anxiety" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
								</TR>
							</TABLE>
