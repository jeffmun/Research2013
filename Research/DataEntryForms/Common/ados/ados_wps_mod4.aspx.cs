...
{
	/// <summary>
	/// Summary description for ados_wps_mod4.
	/// </summary>
	public partial class ados_wps_mod4 : System.Web.UI.Page
	{
		...
		{    
			...
			this.sqlUpdate.Parameters.Add(new System.Data.SqlClient.SqlParameter("@ADOS31", System.Data.SqlDbType.SmallInt, 2, "ADOS31"));
			...
			this.sqlInsert.CommandText = "INSERT INTO gen_ados (indid, ADOSdate, ADOSclin, ADOSmod, ADOSver, verified) VALU" +
				"ES (@indid, @ADOSdate, @ADOSclin, 4, \'WPS\', @verified); SELECT * FROM gen_ados W" +
