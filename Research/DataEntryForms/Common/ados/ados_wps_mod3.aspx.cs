...
{
	/// <summary>
	/// Summary description for ados_wps_mod3.
	/// </summary>
	public partial class ados_wps_mod3 : System.Web.UI.Page
	{
		...
		{    
			...
			this.sqlInsert.CommandText = "INSERT INTO gen_ados (indid, ADOSdate, ADOSclin, ADOSmod, ADOSver, verified) VALU" +
				"ES (@indid, @ADOSdate, @ADOSclin, 3, \'WPS\', @verified); SELECT * FROM gen_ados W" +
