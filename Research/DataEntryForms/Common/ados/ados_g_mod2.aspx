...
<%@ Page language="c#" Inherits="gen_ados_wps.ados_g_mod2" CodeFile="ados_g_mod2.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						...
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="all_ados" LookupField1="id"
							LookupTextBox2Visible="True" LookupTextBox1LabelText="Subject ID:" MeasureName="ADOS-G Module 2" PrimaryKeyField="ados_pk"
							...
							LookupField1DataType="TEXT" LookupField2="indexnum" ShowReliabilityButton="True" LookupTextBox2LabelText="Indexnum" LastScoredDateField="scored" LastUpdatedDateField="updated" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller><br>
						<h3>ADOS G Module 2</h3>
						<table>
							<tr>
								<td>
									<table id="table_insert" class="layout">
										...
										<tr>
											<td><def:datafieldcontrol id="ADOSmod" runat="server" DatabaseField="ADOSmod" FieldTextBoxTabIndex="54" FieldLabelText="ADOSmod"
													...
													FieldTextBoxTextDefault="2"></def:datafieldcontrol></td>
										</tr>
										<tr>
								...
								<TR>
									<TD width="279">
										<def:datafieldcontrol id="ADOS01" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS01"
											...
											FieldDataType="INT" ValidList="0,1,2,7,3,9"></def:datafieldcontrol></TD>
									<TD>
										<def:datafieldcontrol id="ADOS15" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS15"
											FieldTextBoxTabIndex="20" FieldLabelText="B6. Response to joint attn" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									<TD width="279">
										<def:datafieldcontrol id="ADOS07" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS07"
											FieldTextBoxTabIndex="12" FieldLabelText="A7. Response to name" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									<TD width="279">
										<def:datafieldcontrol id="ADOS08" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS08"
											FieldTextBoxTabIndex="13" FieldLabelText="A8. Pointing to express interest" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,3,9"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									<TD width="279">
										<def:datafieldcontrol id="ADOS12" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS12"
											FieldTextBoxTabIndex="17" FieldLabelText="B3. Shared enjoyment" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									<TD width="279">
										<def:datafieldcontrol id="ADOS13" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS13"
											FieldTextBoxTabIndex="18" FieldLabelText="B4. Showing" IsDoubleEntryField="True" IsReadOnly="False"
											IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								...
								<TR>
									<TD width="279">
										<def:datafieldcontrol id="ADOS14" runat="server" FieldTextBoxWidth="40px" FieldLabelWidth="200px" DatabaseField="ADOS14"
											FieldTextBoxTabIndex="19" FieldLabelText="B5. Initiation of joint attn" IsDoubleEntryField="True"
											IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
											FieldDataType="INT" FieldLabelCssClass="boldfieldlabel" ValidList="0,1,2,9"></def:datafieldcontrol></TD>
									<TD>
