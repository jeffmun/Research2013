...
<%@ Page language="c#" Inherits="GenericDataEntryForms.dnms.dnms" CodeFile="dnms.aspx.cs"  MasterPageFile="~/UWAC.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">


<%--		<script language="javascript">
function dnms_onBlur(sFieldID)
{
	unselectField();
...
--%>
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="all_dnms" LookupField1="id"
							LookupTextBox2Visible="False" LookupTextBox1LabelText="Subject ID:" MeasureName="DNMS" PrimaryKeyField="dnms_pk"
							VerifiedField="verified" LookupField1DataType="TEXT" AllowedStudyMeasures="349,481,598,1478,1533,1568"></def:dataentrycontroller>
											...
											<TR>
												...
												<TD>
													<def:datafieldcontrol id="ds05nco" runat="server" RegExDescription="Value must be between 0 and 20 or -9"
														...
														IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" RenderReadOnlyAsDiv="False"
											...
											<TR>
												<TD>
													<def:datafieldcontrol id="dsbeh" runat="server" FieldLabelWidth="80px" FieldTextBoxWidth="200px" DatabaseField="dsbeh"
														...
														FieldDataType="TEXT" FieldTextBoxTextMode="MultiLine" FieldTextBoxHeight="150px" FieldTextBoxMaxLength="255"></def:datafieldcontrol></TD>
											</TR>
											<TR>
												<TD>
