...
<%@ Page language="c#" MasterPageFile="~/UWAC.master"  Title="Medical and Psychiatric History Data Entry" %>
...
<div class="collection">
  <div class="main">
    ...
    <def:datafieldcontrol runat="server" id="hxrelat" DatabaseField="hxrelat" FieldLabelText="Relationship to Subject" IsInsertField="true" FieldLabelWidth="200px" FieldTextBoxWidth="40px"></def:datafieldcontrol>
    <def:datafieldcontrol runat="server" id="hxrelsp" DatabaseField="hxrelsp" FieldLabelText="Specify other relationship" IsInsertField="true" FieldLabelWidth="200px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol>
  </div>
  <div class="key"><def:ValueSetLabel ID="ValueSetLabel_hxrelat" runat="server"  DatabaseField="hxrelat"></def:ValueSetLabel></div>
</div> 
<asp:panel id="mainPanel" CssClass="mainPanel" runat="server">
<div class="legend">For all questions: -1=Missing Value, -7=Do Not Know, -8=Refused to Answer, -9=Does Not Apply</div>

<table class="main" border="1" cellpadding="5" cellspacing="0">
  <tr>
    <td>1. Pregnancy History</td>
    <td>First Pregnancy</td>
    <td>Second Pregnancy</td>
    <td>Third Pregnancy</td>
    <td>Fourth Pregnancy</td>
    <td>Fifth Pregnancy</td>
  </tr>
  <tr>
    <td>a. What was the outcome?<br />
      <span class="legend">
        0=Live birth, child still living<br />
        1=Live birth, child no longer living<br />
        2=Stillbirth<br />
        3=Elective Termination<br />
        4=Miscarriage</span></td>
    <td><def:datafieldcontrol runat="server" id="hx1a1" DatabaseField="hx1a1" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1a2" DatabaseField="hx1a2" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1a3" DatabaseField="hx1a3" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1a4" DatabaseField="hx1a4" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1a5" DatabaseField="hx1a5" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td>b. Date of Birth</td>
    <td><def:datafieldcontrol runat="server" id="hx1b1" DatabaseField="hx1b1" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1b2" DatabaseField="hx1b2" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1b3" DatabaseField="hx1b3" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1b4" DatabaseField="hx1b4" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1b5" DatabaseField="hx1b5" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td>c. At what week did you deliver?<br />
      <span class="legend">
        0=Greater than 37 completed weeks<br />
        1=Less than 28 completed weeks<br />
        2=Between 28 and 32 completed weeks<br />
        3=Between 32 and 37 completed weeks<br />
        4=Fetus age at delivery unknown</span></td>
    <td><def:datafieldcontrol runat="server" id="hx1c1" DatabaseField="hx1c1" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1c2" DatabaseField="hx1c2" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1c3" DatabaseField="hx1c3" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1c4" DatabaseField="hx1c4" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1c5" DatabaseField="hx1c5" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
</table>
...
<table class="main" border="1" cellpadding="5" cellspacing="0">
  <tr>
    <td>1. Pregnancy History</td>
    <td>Sixth Pregnancy</td>
    <td>Seventh Pregnancy</td>
    <td>Eighth Pregnancy</td>
    <td>Ninth Pregnancy</td>
  </tr>
  <tr>
    <td>a. What was the outcome?<br />
      <span class="legend">
        ...
        3=Elective Termination<br />
        4=Miscarriage</span></td>
    <td><def:datafieldcontrol runat="server" id="hx1a6" DatabaseField="hx1a6" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1a7" DatabaseField="hx1a7" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1a8" DatabaseField="hx1a8" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1a9" DatabaseField="hx1a9" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td>b. Date of Birth</td>
    <td><def:datafieldcontrol runat="server" id="hx1b6" DatabaseField="hx1b6" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1b7" DatabaseField="hx1b7" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1b8" DatabaseField="hx1b8" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1b9" DatabaseField="hx1b9" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td>c. At what week did you deliver?<br />
      <span class="legend">
        ...
        3=Between 32 and 37 completed weeks<br />
        4=Fetus age at delivery unknown</span></td>
    <td><def:datafieldcontrol runat="server" id="hx1c6" DatabaseField="hx1c6" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1c7" DatabaseField="hx1c7" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1c8" DatabaseField="hx1c8" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx1c9" DatabaseField="hx1c9" IsEntryField="true" IsDoubleEntryField="true" FieldTextBoxTextDefault="-9" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
</table>



  <div class="main"><def:datafieldcontrol runat="server" id="hx2" DatabaseField="hx2" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<table class="legend" border="0" cellpadding="5" cellspacing="0">
  <tr>
    <td width="180">Child or Relative Has Disorder:</td>
    <td width="75">
      0=No<br />
      1=Yes<br />
      2=Not Sure
...
<table class="main" border="1" cellpadding="5" cellspacing="0">
  <tr>
    ...
    <td>Child or Relative Has Disorder<br />
    <td>Child</td>
...
<div class="collection">
  <div class="main">
    <div class="main"><def:datafieldcontrol runat="server" id="hx4" DatabaseField="hx4" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4a" DatabaseField="hx4a" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4b" DatabaseField="hx4b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4c" DatabaseField="hx4c" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4d" DatabaseField="hx4d" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4e" DatabaseField="hx4e" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4f" DatabaseField="hx4f" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4g" DatabaseField="hx4g" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx4h" DatabaseField="hx4h" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
  </div>
  <div class="key"><def:ValueSetLabel ID="ValueSetLabel_hx4" runat="server"  DatabaseField="hx4"></def:ValueSetLabel></div>
</div>
<div class="indent"><def:datafieldcontrol runat="server" id="hx4hs" DatabaseField="hx4hs" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="300px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></div>
<div class="main">5. At any time in this pregnancy, did you have any of the following health problems?</div>
<div class="collection">
  <div class="main">
    <div class="indent"><def:datafieldcontrol runat="server" id="hx5a" DatabaseField="hx5a" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx5b" DatabaseField="hx5b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx5c" DatabaseField="hx5c" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx5d" DatabaseField="hx5d" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx5e" DatabaseField="hx5e" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx5f" DatabaseField="hx5f" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
  </div>
  <div class="key"><def:ValueSetLabel ID="ValueSetLabel_hx5a" runat="server"  DatabaseField="hx5a"></def:ValueSetLabel></div>
</div>
<div class="indent"><def:datafieldcontrol runat="server" id="hx5fs" DatabaseField="hx5fs" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="300px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></div>
<div class="indent"><def:datafieldcontrol runat="server" id="hx5g" DatabaseField="hx5g" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<div class="indent"><def:datafieldcontrol runat="server" id="hx5h" DatabaseField="hx5h" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<div class="indent"><def:datafieldcontrol runat="server" id="hx5i" DatabaseField="hx5i" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<div class="indent"><def:datafieldcontrol runat="server" id="hx5j" DatabaseField="hx5j" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<table class="legend" border="0" cellpadding="5" cellspacing="0">
  <tr>
    <td width="140">Medication taken during pregnancy:</td>
    <td width="50">
      0=No<br />
      1=Yes
    </td>
    <td width="115">Taken relative to knowing pregnant:</td>
    <td width="65">
      0=Before<br />
      1=After<br />
      2=Both
...
<table class="main" border="1" cellpadding="5" cellspacing="0">
  <tr>
    <td>6. Medication taken during pregnancy?</td>
    <td>When?</td>
    <td rowspan="16">&nbsp;</td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6a" DatabaseField="hx6a" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6awhen" DatabaseField="hx6awhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6b" DatabaseField="hx6b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6bwhen" DatabaseField="hx6bwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6c" DatabaseField="hx6c" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6cwhen" DatabaseField="hx6cwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6d" DatabaseField="hx6d" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6dwhen" DatabaseField="hx6dwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6e" DatabaseField="hx6e" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6ewhen" DatabaseField="hx6ewhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6f" DatabaseField="hx6f" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6fwhen" DatabaseField="hx6fwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6g" DatabaseField="hx6g" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6gwhen" DatabaseField="hx6gwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6h" DatabaseField="hx6h" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6hwhen" DatabaseField="hx6hwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6i" DatabaseField="hx6i" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6iwhen" DatabaseField="hx6iwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6j" DatabaseField="hx6j" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6jwhen" DatabaseField="hx6jwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6k" DatabaseField="hx6k" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6kwhen" DatabaseField="hx6kwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6l" DatabaseField="hx6l" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6lwhen" DatabaseField="hx6lwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6m" DatabaseField="hx6m" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6mwhen" DatabaseField="hx6mwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6n" DatabaseField="hx6n" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6nwhen" DatabaseField="hx6nwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6o" DatabaseField="hx6o" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6owhen" DatabaseField="hx6owhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6p" DatabaseField="hx6p" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6pwhen" DatabaseField="hx6pwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td>Specify</td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6q" DatabaseField="hx6q" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6qwhen" DatabaseField="hx6qwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6qwhy" DatabaseField="hx6qwhy" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="0px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6r" DatabaseField="hx6r" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6rwhen" DatabaseField="hx6rwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6rwhy" DatabaseField="hx6rwhy" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="0px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx6s" DatabaseField="hx6s" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6swhen" DatabaseField="hx6swhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx6sspec" DatabaseField="hx6sspec" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="0px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></td>
  </tr>
</table>
<div class="main">7. Did doctor tell you that the baby had any of the following health problems?</div>
<div class="collection">
  <div class="main">
    <div class="indent"><def:datafieldcontrol runat="server" id="hx7a" DatabaseField="hx7a" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx7b" DatabaseField="hx7b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx7bs" DatabaseField="hx7bs" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="300px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx7c" DatabaseField="hx7c" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx7cs" DatabaseField="hx7cs" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="300px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx7d" DatabaseField="hx7d" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx7ds" DatabaseField="hx7ds" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="300px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></div>
  </div>
  <div class="key"><def:ValueSetLabel ID="ValueSetLabel_hx7a" runat="server"  DatabaseField="hx7a"></def:ValueSetLabel></div>
</div>
<table class="legend" border="0" cellpadding="5" cellspacing="0">
  <tr>
    <td width="95">Activity during pregnancy:</td>
    <td width="50">
      0=No<br />
      1=Yes
    </td>
    <td width="115">Done relative to knowing pregnant:</td>
    <td width="65">
      0=Before<br />
      1=After<br />
      2=Both
...
<table class="main" border="1" cellpadding="5" cellspacing="0">
  <tr>
    <td>8. Activity during pregnancy?</td>
    <td>When?</td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx8a" DatabaseField="hx8a" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx8awhen" DatabaseField="hx8awhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx8b" DatabaseField="hx8b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx8bwhen" DatabaseField="hx8bwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
</table>
<table class="legend" border="0" cellpadding="5" cellspacing="0">
  <tr>
...
<table class="main" border="1" cellpadding="5" cellspacing="0">
  <tr>
    <td>9. Activity during pregnancy?</td>
    <td>When?</td>
    <td rowspan="8">&nbsp;</td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9a" DatabaseField="hx9a" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9awhen" DatabaseField="hx9awhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9b" DatabaseField="hx9b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9bwhen" DatabaseField="hx9bwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9c" DatabaseField="hx9c" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9cwhen" DatabaseField="hx9cwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9d" DatabaseField="hx9d" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9dwhen" DatabaseField="hx9dwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9e" DatabaseField="hx9e" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9ewhen" DatabaseField="hx9ewhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9f" DatabaseField="hx9f" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9fwhen" DatabaseField="hx9fwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9g" DatabaseField="hx9g" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9gwhen" DatabaseField="hx9gwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9h" DatabaseField="hx9h" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9hwhen" DatabaseField="hx9hwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td>Specify</td>
  </tr>
  <tr>
    <td><def:datafieldcontrol runat="server" id="hx9i" DatabaseField="hx9i" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px" CallOnBlur="MedPsychHx_onBlur"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9iwhen" DatabaseField="hx9iwhen" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="0px" FieldTextBoxWidth="40px"></def:datafieldcontrol></td>
    <td><def:datafieldcontrol runat="server" id="hx9is" DatabaseField="hx9is" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="0px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="100"></def:datafieldcontrol></td>
  </tr>
</table>
<div class="collection">
  <div class="main">
    <div class="main"><def:datafieldcontrol runat="server" id="hx10" DatabaseField="hx10" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="main"><def:datafieldcontrol runat="server" id="hx10b" DatabaseField="hx10b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
  </div>
  <div class="key"><def:ValueSetLabel ID="ValueSetLabel_hx10" runat="server"  DatabaseField="hx10"></def:ValueSetLabel></div>
</div>
<div class="main"><def:datafieldcontrol runat="server" id="hx11wtpd" DatabaseField="hx11wtpd" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="200px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<div class="next"><def:datafieldcontrol runat="server" id="hx11wtoz" DatabaseField="hx11wtoz" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="100px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<div class="main"><def:datafieldcontrol runat="server" id="hx11ap1" DatabaseField="hx11ap1" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="200px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<div class="next"><def:datafieldcontrol runat="server" id="hx11ap5" DatabaseField="hx11ap5" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="100px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
<div class="main">12. Did this child need any of the following during/after labor and delivery:</div>
<div class="collection">
  <div class="main">
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12a" DatabaseField="hx12a" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12b" DatabaseField="hx12b" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12c" DatabaseField="hx12c" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12d" DatabaseField="hx12d" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12e" DatabaseField="hx12e" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12f" DatabaseField="hx12f" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12g" DatabaseField="hx12g" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12h" DatabaseField="hx12h" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12i" DatabaseField="hx12i" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12j" DatabaseField="hx12j" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12k" DatabaseField="hx12k" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12l" DatabaseField="hx12l" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12m" DatabaseField="hx12m" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="indent"><def:datafieldcontrol runat="server" id="hx12n" DatabaseField="hx12n" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
  </div>
  <div class="key"><def:ValueSetLabel ID="ValueSetLabel_hx12a" runat="server"  DatabaseField="hx12a"></def:ValueSetLabel></div>
</div>
<div class="collection">
  <div class="main">
    <div class="main"><def:datafieldcontrol runat="server" id="hx13" DatabaseField="hx13" IsEntryField="true" IsDoubleEntryField="true" FieldLabelWidth="300px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    <div class="collection">
      <div class="indent"><def:datafieldcontrol runat="server" id="hx13d" DatabaseField="hx13d" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="100px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
      <div class="next"><def:datafieldcontrol runat="server" id="hx13hr" DatabaseField="hx13hr" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="120px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
    </div>
  </div>
  <div class="key"><def:ValueSetLabel ID="ValueSetLabel_hx13" runat="server"  DatabaseField="hx13"></def:ValueSetLabel></div>
</div>
<div class="main">14. How many days or hours total did this child stay in the hospital?</div>
<div class="collection">
  <div class="indent"><def:datafieldcontrol runat="server" id="hx14d" DatabaseField="hx14d" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="100px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
  <div class="next"><def:datafieldcontrol runat="server" id="hx14hr" DatabaseField="hx14hr" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="120px" FieldTextBoxWidth="40px"></def:datafieldcontrol></div>
</div>
<div class="collection">
...
<div class="main">16. Has this child ever...</div>
<div class="collection">
  <div class="main">
...
<div class="indent">At what age(s) did this child lose consciousness</div>
<div class="collection">
...
<div class="main">17. Did this child have any of the following birth defects?</div>
<div class="collection">
  <div class="main">
