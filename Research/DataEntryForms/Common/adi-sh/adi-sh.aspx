...
<%@ Page language="c#" Inherits="gen_adi.gen_adi" CodeFile="adi-sh.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
{
	//var oIDField = document.getElementById("indid_fieldTextBox");
	var oIDField = document.getElementById("ctl00_oBodyPlaceHolder_indid_fieldTextBox");
	var sID = oIDField.value;
	//var studyMeasField = document.getElementById("studymeasid_fieldTextBox");
	var studyMeasField = document.getElementById("ctl00_oBodyPlaceHolder_studymeasid_fieldTextBox");
	var studyMeasID = studyMeasField.value;

	if (sID == "" || studyMeasID == "")
		alert("Lookup an existing ADI or enter and score a new one first.");
	else
		open("adi-shreport.aspx?ID=" + sID + "&studymeasid=" + studyMeasID );
...
function gen_adi_onLoad()
{
	...
	{
		// get age in months
		var age = parseInt(getFieldValue("<%= Adagemos.ClientID %>"));
		if (!isNaN(age))
		{
			if (age >= 48) setFieldValueIfBlank("<%= AD042cu.ClientID %>", "8");
			
			if (age >=120)
			{
				//<%= AD029cu.ClientID %>
				setFieldValueIfBlank("<%= AD029cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD031cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD063cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD064cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD065cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD066cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD067cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD068cu.ClientID %>", "8");
			}
		
			if (age < 120) setFieldValueIfBlank("<%= AD069mo.ClientID %>", "8");
...
function gen_adi_onBlur(sFieldID)
{
	...
	switch (sFieldID) {
		...
		case "<%= AD019.ClientID %>":
			...
			{
				setFieldValueIfBlank("<%= AD020cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD020mo.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD022cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD022ev.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD023cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD023ev.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD024cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD024ev.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD025cu.ClientID %>", "8");
				setFieldValueIfBlank("<%= AD025ev.ClientID %>", "8");
			}
			break;
						...
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1DataType="TEXT" ShowScoreButton="True"
							VerifiedField="verified" PrimaryKeyField="adi_pk" MeasureName="ADI-R Short Form" LookupTextBox1LabelText="Subject ID:"
							LookupTextBox2Visible="False" LookupField1="id" DatabaseTable="all_adi_sh" StudyMeasID="124" 
							AllowedStudyMeasures="85,101,124,152,214,534,622,665,676,695,696,922,1214,1972,2122,2875"
							LookupField2="indexnum" LookupTextBox2LabelText="Indexnum" LookupColumns="studymeasname,id,indexnum,Adint,Addate{0:d},reliabilitydatedone{0:d}"
							LookupColumnHeaders="Measure,id,indexnum,clin,test date,rel. date" LastScoredDateField="scored" LastUpdatedDateField="updated" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller><br>
<%--						<a id="showreportlink" href="javascript:showADIReport();">Click to View Scoring Summary</a>--%>
	<br>
	<asp:Button ID="btnViewSummary"  runat="server" Text="View Scoring Summary" OnClick="btnViewSummary_Click" Visible="true" />

<%--    class="tblInput"--%>
<asp:Label ID="lblError" Runat="server" ForeColor="red" visible="False" />
<table  cellspacing="0" id="tblMaster" runat="server">
	<tr>
		<td></td>
	</tr>
</table>
						...
						<div class="divDataEntryFields">
								...
								<tr>
									<td width="277">
										<table class="layout" id="table_insert">
											<tr>
												<td><def:datafieldcontrol id="indid" runat="server" FieldTextBoxWidth="80px" FieldDataType="TEXT" IsInsertField="True"
														IsInsertValueRequired="True" IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="False"
														IsDoubleEntryField="False" FieldLabelText="ID" FieldTextBoxTabIndex="6" DatabaseField="id" FieldLabelWidth="150px"></def:datafieldcontrol></td>
											</tr>
											<tr>
												<td><def:datafieldcontrol id="indexnum" runat="server" FieldTextBoxWidth="80px" FieldDataType="INT" IsInsertField="True"
														IsInsertValueRequired="True" IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="False"
														IsDoubleEntryField="False" FieldLabelText="Indexnum" FieldTextBoxTabIndex="6" DatabaseField="indexnum"
														FieldLabelWidth="150px"></def:datafieldcontrol></td>
											</tr>
											<tr>
												<td><def:datafieldcontrol id="Adsex" runat="server" FieldTextBoxWidth="50px" FieldDataType="INT" IsInsertField="True"
														...
														ValidList="0,1" FieldLabelWidth="150px"></def:datafieldcontrol></td>
											</tr>
											<tr>
												<td>
													<def:datafieldcontrol id="Addate" runat="server" FieldTextBoxWidth="75px" FieldDataType="DATE" IsInsertField="True"
											...
											<tr>
												<td><def:datafieldcontrol id="Adint" runat="server" FieldTextBoxWidth="50px" FieldDataType="TEXT" IsInsertField="True"
														IsInsertValueRequired="True" IsEntryField="True" IsEntryValueRequired="True" IsReadOnly="False" IsDoubleEntryField="False"
														FieldLabelText="Interviewer initials" FieldTextBoxTabIndex="18" DatabaseField="Adint" FieldLabelWidth="150px"></def:datafieldcontrol></td>
											</tr>
											<tr>
												<td><def:datafieldcontrol id="Adinf" runat="server" FieldTextBoxWidth="50px" FieldDataType="INT" IsInsertField="True"
														...
														FieldTextBoxTabIndex="19" DatabaseField="Adinf" ValidList="0,1,2,3" FieldLabelWidth="150px"></def:datafieldcontrol></td>
											</tr>
											<tr>
												<td>
													<def:datafieldcontrol id="reliabilityDateDone" runat="server" FieldTextBoxWidth="80px" FieldLabelWidth="150px"
														DatabaseField="reliabilityDateDone" FieldTextBoxTabIndex="19" FieldLabelText="Reliability Date (Leave blank if not entering a reliability)"
							...
							<br>
							<def:datafieldcontrol id="Datafieldcontrol1" runat="server" FieldTextBoxWidth="75px" FieldDataType="TEXT"
								IsInsertField="False" IsInsertValueRequired="False" IsEntryField="False" IsEntryValueRequired="False"
								IsReadOnly="True" IsDoubleEntryField="False" FieldLabelText="Scoring Notes:" FieldTextBoxTabIndex="10"
								DatabaseField="scorcmnt" FieldLabelWidth="100px" RenderReadOnlyAsDiv="True"></def:datafieldcontrol><br>
							<def:datafieldcontrol id="studymeasid" runat="server" FieldTextBoxWidth="80px" FieldDataType="INT" IsInsertField="False"
								IsInsertValueRequired="False" IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="True"
								IsDoubleEntryField="False" FieldLabelText="studymeasid" FieldTextBoxTabIndex="6" DatabaseField="studymeasid"
								FieldLabelWidth="150px" FieldTextBoxCssClass="hideme" ShowFieldLabel="False"></def:datafieldcontrol>
							<def:datafieldcontrol id="Adagemos" runat="server" FieldTextBoxWidth="75px" FieldDataType="TEXT" IsInsertField="False"
								IsInsertValueRequired="False" IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="True"
								IsDoubleEntryField="False" FieldLabelText="Age (months):" FieldTextBoxTabIndex="10" DatabaseField="Adagemos"
								FieldLabelWidth="100px" RenderReadOnlyAsDiv="False" ShowFieldLabel="False" FieldTextBoxCssClass="hideme"></def:datafieldcontrol>
												...
												<TR>
													<TD>
														<def:datafieldcontrol id="AD002" runat="server" DatabaseField="AD002" FieldTextBoxTabIndex="20" FieldLabelText="2. Age noticed concern (months)"
															...
															IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="50px" FormatString="{0:000}" RegEx="^([0-8][0-9][0-9]|99[126789])$"
															RegExDescription="Value must be 3 digits or 991, 992, 996, 997, 998, 999"></def:datafieldcontrol></TD>
												</TR>
												<TR>
													<TD>
												...
												<TR>
													<TD>
														<def:datafieldcontrol id="AD019" runat="server" DatabaseField="AD019" FieldTextBoxTabIndex="32" FieldLabelText="19. Overall language"
															IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
															IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="50px" ValidList="0,1,2,9" CallOnBlur="gen_adi_onBlur"></def:datafieldcontrol></TD>
												</TR>
												<TR>
													<TD>
												...
												<TR>
													<TD>
														<def:datafieldcontrol id="AD096af" runat="server" DatabaseField="AD096af" FieldTextBoxTabIndex="111" FieldLabelText="96. Loss of skills (w/ phys illness) (after age 5.0)"
															IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
															IsInsertField="False" FieldDataType="INT" FieldTextBoxWidth="50px" ValidList="0,1,2,8,9" RenderReadOnlyAsDiv="True"></def:datafieldcontrol></TD>
												</TR>
												<TR>
													<TD>
