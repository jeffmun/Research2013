<%@ Page language="c#" Inherits="kt_anotbid.anotbid" CodeFile="anotbid.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
function unselectABD1FAB()
{
	...
	if (getFieldValue("<%= ABD1FAB.ClientID %>") == 0 )
	{
		setFieldValueIfBlank("<%= ABD1PASS.ClientID %>", "9");

		setFieldValueIfBlank("<%= ABD1STRT.ClientID %>", "9");

		setFieldValueIfBlank("<%= ABD101.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD102.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD103.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD104.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD105.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD106.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD107.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD108.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD109.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD110.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD111.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD112.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD113.ClientID %>", "9");
		setFieldValueIfBlank("<%= ABD114.ClientID %>", "9");

		setFieldValueIfBlank("<%= ABD1R1.ClientID %>", "-9");
		setFieldValueIfBlank("<%= ABD1R2.ClientID %>", "-9");
		setFieldValueIfBlank("<%= ABD1R3.ClientID %>", "-9");

		setFieldValueIfBlank("<%= ABD1OVRN.ClientID %>", "-9");
		setFieldValueIfBlank("<%= ABD1OVRC.ClientID %>", "-9");
		setFieldValueIfBlank("<%= ABD1REVN.ClientID %>", "-9");
		setFieldValueIfBlank("<%= ABD1REVC.ClientID %>", "-9");
		setFieldValueIfBlank("<%= ABD1VLD.ClientID %>", "1");		
...
function unselectABD1PASS()
{
	...
	if (getFieldValue("<%= ABD1PASS.ClientID %>") == 0 )
	{
		setFieldValueIfBlank("<%= ABD1STRT.ClientID %>", "9");
		...
		setFieldValueIfBlank("<%= ABD1VLD.ClientID %>", "1");
						...
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1DataType="TEXT" VerifiedField="verified"
							PrimaryKeyField="anotbid_pk" MeasureName="A Not B w/ID" LookupTextBox1LabelText="Subject ID:" LookupTextBox2Visible="False"
							LookupField1="id" DatabaseTable="all_anotbid" ShowScoreButton="True" LastScoredDateField="scored" LastUpdatedDateField="updated" ondoscore="DataEntryController1_DoScore"
							AllowedStudyMeasures="252,352,483,571"></def:dataentrycontroller>
						...
						<asp:panel id="mainPanel" Runat="server">
							<def:datafieldcontrol id="ABD1FAB" runat="server" FieldTextBoxWidth="40px" DatabaseField="ABD1FAB" FieldTextBoxTabIndex="5"
								...
								FieldDataType="INT" CallOnBlur="unselectABD1FAB" ValidList="0,1,9"></def:datafieldcontrol>
							<BR>
							<def:datafieldcontrol id="ABD1PASS" runat="server" FieldTextBoxWidth="40px" DatabaseField="ABD1PASS" FieldTextBoxTabIndex="5"
								...
								IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
								FieldDataType="INT" CallOnBlur="unselectABD1PASS" ValidList="0,1,9"></def:datafieldcontrol>
							<BR>
							...
							<TABLE class="layout">
								<TR>
									...
									<TD style="vertical-align:top"><SPAN style="COLOR: green">Calculated values in 
            green</SPAN>
										<TABLE class="grid">
											<TR>
											...
											<TR>
												...
												<TD><SPAN style="COLOR: green">
														<def:datafieldcontrol id="ABD1REVP" runat="server" DatabaseField="ABD1REVP" FieldTextBoxTabIndex="10"
															...
															DESIGNTIMEDRAGDROP="146" RenderReadOnlyAsDiv="True" ShowFieldLabel="False"></def:datafieldcontrol>
													</SPAN></TD>
											</TR>
										</TABLE>
