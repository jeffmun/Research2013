...
<%@ Page language="c#" Inherits="tap_vineseec.tap_vineseec" CodeFile="vineseec.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="all_vineseec" LookupField1="id"
							LookupTextBox2Visible="False" LookupTextBox1LabelText="Subject ID:" MeasureName="VINE-SEEC" PrimaryKeyField="vineseec_pk"
							VerifiedField="verified" ShowScoreButton="True" LookupField1DataType="TEXT" AllowedStudyMeasures="565,610,584,615,356,784,753"
						...
						<def:datafieldcontrol id="tapid" runat="server" DatabaseField="id" FieldTextBoxTabIndex="1" FieldLabelText="ID"
							IsDoubleEntryField="False" IsReadOnly="False" IsEntryValueRequired="False" IsEntryField="False" IsInsertValueRequired="True"
							IsInsertField="True" FieldDataType="TEXT" FieldTextBoxWidth="100px" FieldLabelWidth="100px"></def:datafieldcontrol>
						<asp:panel id="mainPanel" runat="server">
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="vsdate" runat="server" FieldLabelWidth="100px" FieldTextBoxWidth="100px" FieldDataType="DATE"
											IsInsertField="False" IsInsertValueRequired="False" IsEntryField="True" IsEntryValueRequired="True"
											IsReadOnly="False" IsDoubleEntryField="True" FieldLabelText="Interview Date" FieldTextBoxTabIndex="3"
							...
							<TABLE class="grid" id="Table1">
								<TR>
									<TD>Scales</TD>
									<TD class="heading" width="118">Raw<BR>
										Score (enter -999 for missing/blank)</TD>
									<TD class="heading">Standard<BR>
										Score</TD>
									<TD class="heading">Percentile<BR>
										Rank</TD>
									<TD class="heading">Descriptive<BR>
										Category</TD>
									<TD class="heading">Age<BR>
										Equivalent</TD>
								</TR>
								<TR>
									<TD class="heading">Interpersonal<BR>
										Relationships</TD>
									<TD width="118">
										<def:datafieldcontrol id="vsirraw" runat="server" FieldTextBoxWidth="50px" FieldDataType="INT" IsInsertField="False"
											IsInsertValueRequired="False" IsEntryField="True" IsEntryValueRequired="True" IsReadOnly="False" IsDoubleEntryField="True"
											FieldLabelText="vsirraw" FieldTextBoxTabIndex="10" DatabaseField="vsirraw" RegExDescription="must be between 0 and 88 or -999"
											RegEx="^([0-9]|[1-7][0-9]|[8][0-8]|-999)$" ShowFieldLabel="False"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									<TD class="heading">Play and Leisure Time</TD>
									<TD width="118">
										<def:datafieldcontrol id="vspltraw" runat="server" FieldTextBoxWidth="50px" FieldDataType="INT" IsInsertField="False"
											IsInsertValueRequired="False" IsEntryField="True" IsEntryValueRequired="True" IsReadOnly="False" IsDoubleEntryField="True"
											FieldLabelText="vspltraw" FieldTextBoxTabIndex="11" DatabaseField="vspltraw" RegExDescription="must be between 0 and 88 or -999"
											RegEx="^([0-9]|[1-7][0-9]|[8][0-8]|-999)$" ShowFieldLabel="False"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									<TD class="heading">Coping Skills</TD>
									<TD width="118">
										<def:datafieldcontrol id="vscsraw" runat="server" FieldTextBoxWidth="50px" FieldDataType="INT" IsInsertField="False"
											IsInsertValueRequired="False" IsEntryField="True" IsEntryValueRequired="True" IsReadOnly="False" IsDoubleEntryField="True"
											FieldLabelText="vscsraw" FieldTextBoxTabIndex="12" DatabaseField="vscsraw" RegExDescription="must be between 0 and 68 or -999"
											RegEx="^([0-9]|[1-5][0-9]|[6][0-8]|-999)$" ShowFieldLabel="False"></def:datafieldcontrol></TD>
									<TD>
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="vscmt" runat="server" FieldLabelWidth="150px" FieldTextBoxWidth="200px" FieldDataType="TEXT"
											...
											DatabaseField="vscmt" FieldTextBoxMaxLength="200" FieldTextBoxTextMode="MultiLine" FieldTextBoxHeight="150px"></def:datafieldcontrol></TD>
								</TR>
							</TABLE>
							<BR>
