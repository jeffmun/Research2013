<%@ Page language="c#" Inherits="kt_lifeevents.kt_lifeevents" CodeFile="lifeevents.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="id" VerifiedField="verified"
							PrimaryKeyField="le_pk" MeasureName="Life Events" LookupTextBox2Visible="False" LookupTextBox1LabelText="Subject ID:"
							DatabaseTable="all_lifeevents" LookupField1DataType="TEXT" ShowScoreButton="False" 
							></def:dataentrycontroller>
<%-- 						AllowedStudyMeasures="197,272,273,321,358,420,494,495,507,508,574,689,768,773,1172,1173,1174,1215,1216,1444,1486,1525,1560,1708,1736,1797,1890,1896,1897,1898,1899,1929,1942,2060,2171,2188,2223,2854,2917,2943"--%>
							...
							<TABLE class="grid">
								...
								<TR>
									<TD>0=Self/Subject<BR>
										...
										<def:datafieldcontrol id="LEresp" runat="server" FieldTextBoxWidth="30px" DatabaseField="LEresp" FieldTextBoxTabIndex="2"
										...
										<def:datafieldcontrol id="LErespt" runat="server" FieldTextBoxWidth="200px" DatabaseField="LErespt" FieldTextBoxTabIndex="2"
											FieldLabelText="(specify if 3 or 4)" IsDoubleEntryField="False" IsReadOnly="False" IsEntryValueRequired="False"
											IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="TEXT" FieldLabelWidth="130px"></def:datafieldcontrol><BR>
									</TD>
								</TR>
							</TABLE>
							<BR>
											...
											<TR>
												<TD>
													<def:datafieldcontrol id="LE1OC01" runat="server" FieldTextBoxWidth="40px" DatabaseField="LE1OC01" FieldTextBoxTabIndex="5"
														...
														FieldDataType="INT" ValidList="0,1,2,9" FieldLabelWidth= "300px"></def:datafieldcontrol></TD>
												<TD>
											...
											<TR>
												<TD>
													<def:datafieldcontrol id="LE1OC03" runat="server" FieldTextBoxWidth="40px" DatabaseField="LE1OC03" FieldTextBoxTabIndex="5"
														...
														IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" ValidList="0,1,2,9" FieldLabelWidth= "300px"></def:datafieldcontrol></TD>
												<TD>
											...
											<TR>
												<TD>
													<def:datafieldcontrol id="LE1OC37G" runat="server" FieldTextBoxWidth="40px" DatabaseField="LE1OC37G" FieldTextBoxTabIndex="5"
														FieldLabelText="37g.  Serious illness or injury of Partner" IsDoubleEntryField="True" IsReadOnly="False"
														IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False"
														FieldDataType="INT" ValidList="0,1,2,9" FieldLabelWidth= "300px"></def:datafieldcontrol></TD>
												<TD>
											...
											<TR>
												<TD>
													<def:datafieldcontrol id="LE1OC38G" runat="server" FieldTextBoxWidth="40px" DatabaseField="LE1OC38G" FieldTextBoxTabIndex="5"
														FieldLabelText="38g.  Death of Partner" IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True"
														IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" ValidList="0,1,2,9" FieldLabelWidth= "300px"></def:datafieldcontrol></TD>
												<TD>
