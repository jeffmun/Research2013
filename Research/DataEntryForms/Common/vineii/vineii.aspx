...
<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="ALL_VineII" PrimaryKeyField="vineii_pk" >
...
<div class="main">
  ...
  <def:datafieldcontrol runat="server" id="indexnum" DatabaseField="indexnum" IsInsertField="true" FieldTextBoxTextDefault="1" FieldLabelWidth="200px" FieldTextBoxWidth="40px"></def:datafieldcontrol>
     ...
     <def:datafieldcontrol runat="server" id="TEST_DATE" DatabaseField="TEST_DATE" FieldLabelText="Interview Date" FormatString="{0:d}" IsEntryField="true" IsEntryValueRequired="true"  IsDoubleEntryField="true" FieldLabelWidth="200px" FieldTextBoxWidth="150px" ></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="EXAMINER" DatabaseField="EXAMINER" FieldLabelText="Examiner" IsEntryField="true" IsEntryValueRequired="true"  IsDoubleEntryField="true" FieldLabelWidth="200px" FieldTextBoxWidth="150px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="FORM" DatabaseField="FORM" FieldLabelText="Form Version (Survey Interview, Parent/Caregiver Rating)" IsEntryField="true" IsEntryValueRequired="true"  IsDoubleEntryField="true" FieldTextBoxWidth="150px" FieldTextBoxTextDefault="Survey Interview" FieldLabelWidth="200px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="RESPONDENT_SEX" DatabaseField="RESPONDENT_SEX" IsEntryField="true" IsEntryValueRequired="true"  IsDoubleEntryField="true" FieldLabelWidth="200px" FieldTextBoxWidth="40px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="RELATIONSHIP" DatabaseField="RELATIONSHIP" IsEntryField="true" IsEntryValueRequired="true"  IsDoubleEntryField="true" FieldLabelWidth="200px" FieldTextBoxWidth="150px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>

<%--  <def:datafieldcontrol runat="server" id="Datafieldcontrol1" DatabaseField="TEST_DATE" FieldLabelText="Interview Date" FormatString="{0:d}" IsInsertField="true" FieldLabelWidth="200px" FieldTextBoxWidth="150px" ></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="Datafieldcontrol2" DatabaseField="EXAMINER" FieldLabelText="Examiner" IsInsertField="true" FieldLabelWidth="200px" FieldTextBoxWidth="150px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="Datafieldcontrol3" DatabaseField="FORM" FieldLabelText="Form Version (Survey Interview, Parent/Caregiver Rating)" IsInsertField="true" FieldTextBoxWidth="150px" FieldTextBoxTextDefault="Survey Interview" FieldLabelWidth="200px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="Datafieldcontrol4" DatabaseField="RESPONDENT_SEX" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="200px" FieldTextBoxWidth="40px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>
  <def:datafieldcontrol runat="server" id="Datafieldcontrol5" DatabaseField="RELATIONSHIP" IsEntryField="true" IsDoubleEntryField="false" FieldLabelWidth="200px" FieldTextBoxWidth="150px" FieldTextBoxMaxLength="50"></def:datafieldcontrol>--%>
...
<table>
    <tr>
        <td> <h5 class="main" style="color:darkblue"><b><u>Adaptive Behavior</u></b></h5></td>
        <td width="50"></td>
        <td>
            <a name="rawmbi"></a>
            <h5 class="main" style="color:darkblue"><b><u>Maladaptive Behavior</u></b></h5>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#mbiitems">Jump to MBI item entry</a>
...
<td></td><td> <b><def:datafieldcontrol runat="server" id="ABC_STANINE" DatabaseField="ABC_STANINE" IsReadOnly="true"  ShowFieldLabel="false"    FieldLabelWidth="50px" FieldTextBoxWidth="250px" FieldTextBoxMaxLength="50" RenderReadOnlyAsDiv = "true" ></def:datafieldcontrol> </b></td> 
        ...
        <td style="vertical-align:top">
            ...
            <table>
                <tr>
                    <td>
                        <table class="main" border="1px" style="border-collapse: collapse">  
                        <tr>
                            <td><u>Domain</u></td>
                            <td><u>Raw score</u></td>
                            <td><u>V scaled score<br/><b>Std Score</b></u></td>
                ...
                <tr>
                    <td>
                        <%--<def:datafieldcontrol runat="server" id="mbiscrmsg" DatabaseField="mbiscrmsg" IsReadOnly="true" FieldLabelWidth="100px" FieldTextBoxWidth="250px" RenderReadOnlyAsDiv = "true" ></def:datafieldcontrol>  --%>
                    </td>
                </tr>
            </table>
...
<td> <def:datafieldcontrol runat="server" id="v2comments"  DatabaseField="v2comments"  IsEntryField="true" IsEntryValueRequired="false" IsDoubleEntryField="false"  FieldTextBoxMaxLength="250" 
        ShowFieldLabel="true"    FieldTextBoxWidth="400px" FieldTextBoxHeight="40px" FieldTextBoxTextMode="multiline" ></def:datafieldcontrol> </td> 
        </tr>
    </table>
</div>
...
<div class="collection">
    ...
    <div class="continue" style="padding-left:25px"><a href="#rawmbi">Jump to MBI raw scores</a></div>
</div>
...
<div class="collection">
    ...
    <div class="continue" style="padding-left:25px"><a href="#rawmbi">Jump to raw MBI scores</a></div>
</div>
