...
<%@ Page language="c#" Inherits="edst3_srs.edst3_srs" CodeFile="edst3_srs.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" VerifiedField="verified" PrimaryKeyField="srs_pk"
							MeasureName="EDST3 Social Responsiveness Scale" LookupTextBox1LabelText="EDS ID:" LookupTextBox2Visible="False"
							LookupField1="edsid" DatabaseTable="edst3_srs" StudyMeasID="441"></def:dataentrycontroller>
						...
						<asp:Panel Runat="server" ID="mainPanel">
							<TABLE class="grid" id="table_entry">
								<TR>
									<TD class="heading">0=Not TRUE, 1=Sometimes TRUE, 2=Often TRUE, 3=Almost Always 
										TRUE, 9=Missing</TD>
								</TR>
								<TR>
									<TD>
