<%@ Page language="c#" Inherits="edst3_qps_socsupport.edst3_qps_socsupport" CodeFile="edst3_qps_socsupport.aspx.cs"  MasterPageFile="~/UWAC.master" %>

<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="edst3_qps_socsupport" LookupField1="edsid"
							LookupTextBox2Visible="False" LookupTextBox1LabelText="EDS ID:" MeasureName="EDST3 Spouse Soc. Support"
							PrimaryKeyField="ssq_pk" VerifiedField="verified" StudyMeasID="326"></def:dataentrycontroller>
