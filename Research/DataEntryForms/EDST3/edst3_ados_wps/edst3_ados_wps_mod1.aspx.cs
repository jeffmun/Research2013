...
{
	/// <summary>
	/// Summary description for edst3_ados_wps_mod1.
	/// </summary>
	public partial class edst3_ados_wps_mod1 : System.Web.UI.Page
	{
		...
		private const int ADOS_MODULE = 1;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			evtHandler.InsertSqlCommandText = "INSERT INTO edst3_ados_wps (edsid, ADOSdate, ADOSclin, ADOSmod, verified) VALUES (@edsid, @ADOSdate, @ADOSclin, 1, @verified); SELECT * FROM edst3_ados_wps WHERE adoswps_pk = @@IDENTITY;";
			evtHandler.LookupSqlCommandText = "SELECT EDST3_ADOS_WPS.* FROM EDST3_ADOS_WPS WHERE (edsid = @edsid) AND (ADOSmod = 1)";
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.edst3_ados_wps_mod1_PreRender);
		...
		protected void edst3_ados_wps_mod1_PreRender(object sender, System.EventArgs e)
		{
			/*
