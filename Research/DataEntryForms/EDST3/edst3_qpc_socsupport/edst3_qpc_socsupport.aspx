<%@ Page language="c#" Inherits="edst3_qpc_socsupport.edst3_qpc_socsupport" CodeFile="edst3_qpc_socsupport.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>

<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="edst3_qpc_socsupport" LookupField1="edsid"
							LookupTextBox2Visible="False" LookupTextBox1LabelText="EDS ID:" MeasureName="EDST3 Caregiver Soc. Support"
							PrimaryKeyField="ssq_pk" VerifiedField="verified" StudyMeasID="199"></def:dataentrycontroller>
								...
								<TR>
									...
									<TD>
										<def:datafieldcontrol id="SOC11AT" runat="server" FieldTextBoxWidth="50px" DatabaseField="SOC11AT" FieldTextBoxTabIndex="14"
											...
											IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" ValidList="1,2,3,4,5,6,7,9"
