...
namespace EDST3DataEntryForms.edst2_battsoc
{
	/// <summary>
	/// Summary description for edst2_battsoc.
	/// </summary>
	public partial class edst2_battsoc : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.edst2_battsoc_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreBattelle.Parameters["@studyid"].Value = 2;
		...
		protected void edst2_battsoc_PreRender(object sender, System.EventArgs e)
		{
