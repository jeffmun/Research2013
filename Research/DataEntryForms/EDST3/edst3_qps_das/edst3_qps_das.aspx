...
<%@ Page language="c#" Inherits="edst3_qps_das.edst3_qps_das" CodeFile="edst3_qps_das.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="edsid" VerifiedField="verified"
							PrimaryKeyField="das_pk" MeasureName="EDST3 DAS Spouse" LookupTextBox2Visible="False" LookupTextBox1LabelText="EDS ID:"
							DatabaseTable="edst3_qps_das" StudyMeasID="325"></def:dataentrycontroller>
