...
namespace edst3_nepsy
{
	/// <summary>
	/// Summary description for edst3_nepsy.
	/// </summary>
	public partial class edst3_nepsy : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.edst3_nepsy_PreRender);

		}
		#endregion

		protected void edst3_nepsy_PreRender(object sender, System.EventArgs e)
		{
