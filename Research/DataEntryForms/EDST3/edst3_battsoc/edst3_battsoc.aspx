<%@ Page language="c#" Inherits="edst3_battsoc.edst3_battsoc" CodeFile="edst3_battsoc.aspx.cs"  MasterPageFile="~/UWAC.master" %>

<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" ShowScoreButton="True" DatabaseTable="edst3_battelle"
							LookupField1="edsid" LookupTextBox2Visible="False" LookupTextBox1LabelText="EDS ID:" MeasureName="EDST3 Battelle Soc"
							PrimaryKeyField="batt_pk" VerifiedField="verified" StudyMeasID="190" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
									...
									<table class="layout" id="table_insert">
										<tr>
											<td><def:datafieldcontrol id="edsid" runat="server" FieldDataType="INT" IsInsertField="True" IsInsertValueRequired="True"
													...
													FieldTextBoxTabIndex="1" DatabaseField="edsid" FieldTextBoxWidth="80px" FieldLabelWidth="80px"></def:datafieldcontrol></td>
										</tr>
										<tr>
											<td><def:datafieldcontrol id="date" runat="server" FieldDataType="DATE" IsInsertField="False" IsInsertValueRequired="False"
													...
													FieldTextBoxTabIndex="2" DatabaseField="date" FieldTextBoxWidth="80px" FieldLabelWidth="80px" FormatString="{0:d}"></def:datafieldcontrol></td>
										</tr>
										<tr>
											<td><def:datafieldcontrol id="exprmtr" runat="server" FieldDataType="TEXT" IsInsertField="False" IsInsertValueRequired="False"
													...
													FieldTextBoxTabIndex="3" DatabaseField="exprmtr" FieldTextBoxWidth="80px" FieldLabelWidth="80px"></def:datafieldcontrol></td>
										</tr>
									</table>
								</td>
								<td><def:datafieldcontrol id="Datafieldcontrol2" runat="server" FieldDataType="INT" IsInsertField="False"
										IsInsertValueRequired="False" IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="True"
										IsDoubleEntryField="False" FieldLabelText="Age (months):" FieldTextBoxTabIndex="3" DatabaseField="psagem"
										FieldTextBoxWidth="80px" FieldLabelWidth="100px" RenderReadOnlyAsDiv="True"></def:datafieldcontrol>
									<TABLE class="grid">
										<tr>
									...
									<def:datafieldcontrol id="Datafieldcontrol3" runat="server" FieldDataType="TEXT" IsInsertField="False"
										...
										FieldTextBoxWidth="300px" FieldLabelWidth="150px" RenderReadOnlyAsDiv="True" ShowFieldLabel="True"
										FieldDivCssClass="dataentryfield"></def:datafieldcontrol></td>
							</tr>
						</table>
						<br>
