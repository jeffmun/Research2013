...
namespace edst3_NonWordRep
{
	/// <summary>
	/// Summary description for edst3_NonWordRep.
	/// </summary>
	public partial class edst3_NonWordRep : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.edst3_NonWordRep_PreRender);

		}
		#endregion

		protected void edst3_NonWordRep_PreRender(object sender, System.EventArgs e)
		{
