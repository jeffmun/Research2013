...
{
	/// <summary>
	/// Summary description for eds_vine.
	/// </summary>
	public partial class eds_vine : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.eds_vine_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreVineland.Parameters["@studyid"].Value = 3;
		...
		protected void eds_vine_PreRender(object sender, System.EventArgs e)
		{
			if (!this.IsPostBack && this.Request.QueryString["id"] != null 
				&& this.Request.QueryString["IndexNum"] != null)
			{
