...
<%@ Page language="c#" Inherits="edst3_qpc_bsi.edst3_qpc_bsi" CodeFile="edst3_qpc_bsi.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" VerifiedField="verified" PrimaryKeyField="bsi_pk"
							MeasureName="EDST3 Caregiver BSI" LookupTextBox1LabelText="EDS ID:" LookupTextBox2Visible="False" LookupField1="edsid"
							DatabaseTable="edst3_qpc_bsi" StudyMeasID="200"></def:dataentrycontroller>
