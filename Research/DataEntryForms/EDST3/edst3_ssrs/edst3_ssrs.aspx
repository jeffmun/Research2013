<%@ Page language="c#" Inherits="edst3_ssrs.edst3_ssrs" CodeFile="edst3_ssrs.aspx.cs"  MasterPageFile="~/UWAC.master" %>

<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
					<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="edst3_ssrs" LookupField1="edsid"
						LookupTextBox2Visible="False" LookupTextBox1LabelText="EDS ID:" MeasureName="EDST3 Social Skills Rating System"
						PrimaryKeyField="ssrs_pk" VerifiedField="verified" StudyMeasID="322" ShowScoreButton="True" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						...
						<TABLE class="layout">
							<TR>
								...
								<TD style="vertical-align:top" width="227">
									<TABLE class="grid">
										<TR>
											<TD class="heading" width="129">PROBLEM BEHAVIORS</TD>
											<TD></TD>
										</TR>
										<TR>
								...
								<TD style="vertical-align:top">
									<TABLE class="grid">
										<TR>
											<TD class="heading" width="108">ACADEMIC COMPETENCE</TD>
											<TD></TD>
										</TR>
										<TR>
