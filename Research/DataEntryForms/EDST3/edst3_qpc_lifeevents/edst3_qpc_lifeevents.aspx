...
<%@ Page language="c#" Inherits="edst3_qpc_lifeevents.edst3_qpc_lifeevents" CodeFile="edst3_qpc_lifeevents.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="edst3_qpc_lifeevents" LookupField1="edsid"
							LookupTextBox1LabelText="EDS ID:" LookupTextBox2Visible="False" MeasureName="EDST3 Caregiver Life Events"
							PrimaryKeyField="le_pk" VerifiedField="verified" StudyMeasID="197"></def:dataentrycontroller>
