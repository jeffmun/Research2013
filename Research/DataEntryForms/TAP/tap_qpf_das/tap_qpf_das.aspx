...
<%@ Page language="c#" Inherits="tap_qpf_das.tap_qpf_das" CodeFile="tap_qpf_das.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="tapid" VerifiedField="verified"
							PrimaryKeyField="das_pk" MeasureName="TAP Father Dyad. Adj. Questionnaire" LookupTextBox2Visible="False"
							LookupTextBox1LabelText="TAP ID:" DatabaseTable="tap_qpf_das" LookupField1DataType="TEXT" ShowScoreButton="False" StudyMeasID="419"></def:dataentrycontroller>
						<table class="default">
							<tr>
