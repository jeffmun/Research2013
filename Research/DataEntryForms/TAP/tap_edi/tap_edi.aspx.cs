...
namespace tap_edi
{
	...
	/// </summary>
	public partial class tap_edi : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.tap_edi_PreRender);

		}
		#endregion

		protected void tap_edi_PreRender(object sender, System.EventArgs e)
		{
