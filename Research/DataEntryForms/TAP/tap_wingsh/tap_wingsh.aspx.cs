...
namespace tap_wingsh
{
	/// <summary>
	/// Summary description for tap_wingsh.
	/// </summary>
	public partial class tap_wingsh : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.tap_wingsh_PreRender);

		}
		#endregion

		protected void tap_wingsh_PreRender(object sender, System.EventArgs e)
		{
