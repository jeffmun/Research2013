<%@ Page language="c#" Inherits="tap_adi_toddler.tap_adi_toddler" CodeFile="tap_adi_toddler.aspx.cs"  MasterPageFile="~/UWAC.master" %>

<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" SaveButtonText="Save" LookupField1DataType="TEXT"
							LookupTextBox1LabelText="TAP ID:" PrimaryKeyField="adi_toddler_pk" MeasureName="TAP ADI Toddler" VerifiedField="verified"
							ShowScoreButton="True" LookupTextBox2Visible="False" LookupField1="id" DatabaseTable="tap_adi_toddler" StudyMeasID="432" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller><br/>
						<A id="showreportlink" href="javascript:showADIReport('id_fieldTextBox', 'TAPADI.aspx');">
							Click to View Scoring Summary (opens in new window)</A><br/>
						<br/>
						<div class="divDataEntryFields">
							<table class="tblinsert" id="table_insert">
								<tr>
									<td><def:datafieldcontrol id="id" runat="server" RegEx="^[T][A][P][0-9][0-9][0-9]$" RegExDescription="TAP ID must  look like TAP###"
								...
								<tr>
									<td><def:datafieldcontrol id="Adsex" runat="server" DatabaseField="Adsex" FieldTextBoxTabIndex="6" FieldLabelText="Sex (0=male, 1=female)"
											IsDoubleEntryField="False" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="True"
											IsInsertField="True" FieldDataType="INT" FieldTextBoxWidth="50px" FieldLabelWidth="200px"></def:datafieldcontrol></td>
								</tr>
								<tr>
								...
								<tr>
									<td><def:datafieldcontrol id="AdDOB" runat="server" DatabaseField="AdDOB" FieldTextBoxTabIndex="9" FieldLabelText="Subject's DOB"
											IsDoubleEntryField="False" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="True"
											IsInsertField="True" FieldDataType="DATE" FieldTextBoxWidth="100px" FormatString="{0:d}" FieldLabelWidth="200px"></def:datafieldcontrol></td>
								</tr>
								<tr>
							...
							<br/>
							<asp:panel id="mainPanel" runat="server" Height="4232px" Width="826px">
								<TABLE>
									<TR>
										<TD>
											...
											<P>
												<TABLE id="table47" cellSpacing="1" cellPadding="1" width="300" border="1">
													<TR class="boldsmalllabel">
														<TD>47. Skill</TD>
														<TD>Had skill before 24 months</TD>
														<TD>Stopped using the skill for a month or more before 36 months</TD>
														<TD>Can do now</TD>
														<TD>Never had</TD>
													</TR>
													<TR>
														<TD class="boldsmalllabel">Respond to name</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Maintain eye contact</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Respond to parent smile</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Babble</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Respond to smiles of others</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Play Peek-a-boo</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Say or understand “Uh oh”*</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Say or understand “Mommy”*</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">React to “There’s Mommy/Daddy”</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Say or understand “Hi”*</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Understand “Come here/Come on”*</TD>
														<TD>
													...
													<TR>
														<TD class="boldsmalllabel">Understand “Look/Look here”</TD>
														<TD>
											...
											<TABLE id="Table2" style="WIDTH: 280px; HEIGHT: 170px" cellSpacing="1" cellPadding="1"
												border="1">
												<TR>
													<TD class="boldsmalllabel" colSpan="3">82. Cuddliness</TD>
												</TR>
												<TR>
													<TD></TD>
													<TD class="boldsmalllabel">CURRENT</TD>
													<TD class="boldsmalllabel">AS INFANT(6 MO.)</TD>
												</TR>
												<TR>
													<TD class="boldsmalllabel">MOTHER</TD>
													<TD>
												...
												<TR>
													<TD class="boldsmalllabel">FATHER</TD>
													<TD>
												...
												<TR>
													<TD class="boldsmalllabel">OTHER</TD>
													<TD>
