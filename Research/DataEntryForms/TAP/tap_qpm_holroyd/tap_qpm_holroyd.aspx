<%@ Page language="c#" Inherits="tap_qpm_holroyd.tap_qpm_holroyd" CodeFile="tap_qpm_holroyd.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="tapid" VerifiedField="verified"
							PrimaryKeyField="hol_pk" MeasureName="TAP Mother Parent Stress (Holroyd)" LookupTextBox2Visible="False"
							LookupTextBox1LabelText="TAP ID:" DatabaseTable="tap_qpm_holroyd" LookupField1DataType="TEXT" ShowScoreButton="False" StudyMeasID="359"></def:dataentrycontroller>
