...
namespace tap_bitsea
{
	/// <summary>
	/// Summary description for tap_bitsea.
	/// </summary>
	public partial class tap_bitsea : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.tap_bitsea_PreRender);

		}
		#endregion

		protected void tap_bitsea_PreRender(object sender, System.EventArgs e)
		{
