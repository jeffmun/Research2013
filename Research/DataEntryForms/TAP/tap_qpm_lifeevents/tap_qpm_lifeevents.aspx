<%@ Page language="c#" Inherits="tap_qpm_lifeevents.tap_qpm_lifeevents" CodeFile="tap_qpm_lifeevents.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="tapid" VerifiedField="verified"
							PrimaryKeyField="le_pk" MeasureName="TAP Mother Life Events" LookupTextBox2Visible="False" LookupTextBox1LabelText="TAP ID:"
							DatabaseTable="tap_qpm_lifeevents" LookupField1DataType="TEXT" ShowScoreButton="False" StudyMeasID="358"></def:dataentrycontroller>
