...
<%@ Page language="c#" Inherits="tap_vine.tap_vine" CodeFile="tap_vine.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="id" VerifiedField="verified"
							PrimaryKeyField="identityID" MeasureName="TAP Vineland" LookupTextBox2Visible="False" LookupTextBox1LabelText="TAP ID:"
							DatabaseTable="tap_vine" LookupField1DataType="TEXT" ShowScoreButton="True" StudyMeasID="355" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout">
							<tr>
								<td style="vertical-align:top">
									<table class="layout" id="table_insert">
										<tr>
											<td><def:datafieldcontrol id="ID" runat="server" FieldLabelWidth="80px" FieldTextBoxWidth="100px" RegExDescription="TAP ID must  look like TAP###"
													RegEx="^[T][A][P][0-9][0-9][0-9]$" FieldDataType="TEXT" IsInsertField="True" IsInsertValueRequired="True"
													IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="False" IsDoubleEntryField="False" FieldLabelText="TAP ID"
													FieldTextBoxTabIndex="1" DatabaseField="ID"></def:datafieldcontrol></td>
										</tr>
										<tr>
								...
								<TR>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Crecraw" runat="server" DatabaseField="Crecraw" FieldTextBoxTabIndex="6" FieldLabelText="Crecraw"
														...
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|1[0-9]|2[0-6]|999)$" RegExDescription="Must be 0-26 or 999"
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Cexpraw" runat="server" DatabaseField="Cexpraw" FieldTextBoxTabIndex="7" FieldLabelText="Cexpraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-5][0-9]|6[0-2]|999)$" RegExDescription="Must be 0-62 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Cwriraw" runat="server" DatabaseField="Cwriraw" FieldTextBoxTabIndex="8" FieldLabelText="Cwriraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-3][0-9]|4[0-6]|999)$" RegExDescription="Must be 0-46 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Dperraw" runat="server" DatabaseField="Dperraw" FieldTextBoxTabIndex="9" FieldLabelText="Dperraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-6][0-9]|7[0-8]|999)$" RegExDescription="Must be 0-78 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Ddomraw" runat="server" DatabaseField="Ddomraw" FieldTextBoxTabIndex="10" FieldLabelText="Ddomraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-3][0-9]|4[0-2]|999)$" RegExDescription="Must be 0-42 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Dcomraw" runat="server" DatabaseField="Dcomraw" FieldTextBoxTabIndex="11" FieldLabelText="Dcomraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-5][0-9]|6[0-4]|999)$" RegExDescription="Must be 0-64 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Sintrraw" runat="server" DatabaseField="Sintrraw" FieldTextBoxTabIndex="12"
														...
														IsEntryField="True" IsInsertValueRequired="False" IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-4][0-9]|5[0-6]|999)$"
														RegExDescription="Must be 0-56 or 999" FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Splaraw" runat="server" DatabaseField="Splaraw" FieldTextBoxTabIndex="13" FieldLabelText="Splaraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-3][0-9]|40|999)$" RegExDescription="Must be 0-40 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Scopraw" runat="server" DatabaseField="Scopraw" FieldTextBoxTabIndex="14" FieldLabelText="Scopraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-2][0-9]|3[0-6]|999)$" RegExDescription="Must be 0-36 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
											...
											<TR>
												...
												<TD width="77">
													<def:datafieldcontrol id="Mfinraw" runat="server" DatabaseField="Mfinraw" FieldTextBoxTabIndex="16" FieldLabelText="Mfinraw"
														IsDoubleEntryField="True" IsReadOnly="False" IsEntryValueRequired="True" IsEntryField="True" IsInsertValueRequired="False"
														IsInsertField="False" FieldDataType="INT" RegEx="^([0-9]|[1-2][0-9]|3[0-2]|999)$" RegExDescription="Must be 0-32 or 999"
														FieldTextBoxWidth="40px" ShowFieldLabel="False"></def:datafieldcontrol></TD>
												<TD></TD>
												<TD></TD>
												<TD>
									...
									<TD style="vertical-align:top">
										...
										<def:datafieldcontrol id="VineCmnt" runat="server" DatabaseField="VineCmnt" FieldTextBoxTabIndex="18"
											...
											ShowFieldLabel="False" FieldTextBoxTextMode="MultiLine" FieldTextBoxHeight="150px" FieldTextBoxMaxLength="255"></def:datafieldcontrol></TD>
								</TR>
							</TABLE>
