...
{
	/// <summary>
	/// Summary description for tap_vine.
	/// </summary>
	public partial class tap_vine : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.tap_vine_PreRender);
		...
		protected void DataEntryController1_DoScore(object sender, System.EventArgs e)
		{
			try 
			{
				...
				this.sqlScoreVineland.Parameters["@studyid"].Value = 1011;
		...
		protected void tap_vine_PreRender(object sender, System.EventArgs e)
		{
