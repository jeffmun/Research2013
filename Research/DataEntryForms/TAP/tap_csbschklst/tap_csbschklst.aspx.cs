...
namespace tap_csbschklst
{
	/// <summary>
	/// Summary description for tap_csbschklst.
	/// </summary>
	public partial class tap_csbschklst : System.Web.UI.Page
	{
		...
		{    
			...
			this.PreRender += new System.EventHandler(this.tap_csbschklst_PreRender);

		}
		#endregion

		protected void tap_csbschklst_PreRender(object sender, System.EventArgs e)
		{
