...
<%@ Page language="c#" Inherits="tap_qps_bsi.tap_qps_bsi" CodeFile="tap_qps_bsi.aspx.cs"  MasterPageFile="~/UWAC.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="tap_qps_bsi" LookupField1="tapid"
							LookupTextBox2Visible="False" LookupTextBox1LabelText="TAP ID:" MeasureName="TAP Spouse BSI" PrimaryKeyField="bsi_pk"
							VerifiedField="verified" LookupField1DataType="TEXT" StudyMeasID="418"></def:dataentrycontroller>
