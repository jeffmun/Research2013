...
<%@ Page language="c#" Inherits="tap_anotb.tap_anotb" CodeFile="tap_anotb.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
function unselectAB1TRAIN()
{
	...
	if (getFieldValue("AB1TRAIN") == 0 )
	{

		setFieldValueIfBlank("AB1SSIDE", "9");
		setFieldValueIfBlank("AB11RV5", "-9");
		setFieldValueIfBlank("AB12RV5", "-9");
		setFieldValueIfBlank("AB13RV12", "-9");
		setFieldValueIfBlank("AB14RV12", "-9");
		setFieldValueIfBlank("AB15OCO", "-9");
		setFieldValueIfBlank("AB15OTR", "-9");
		setFieldValueIfBlank("AB112OCO", "-9");
		setFieldValueIfBlank("AB112OTR", "-9");
		setFieldValueIfBlank("AB1VLD", "1");

		setFieldValueIfBlank("AB101", "9");
		setFieldValueIfBlank("AB102", "9");
		setFieldValueIfBlank("AB103", "9");
		setFieldValueIfBlank("AB104", "9");
		setFieldValueIfBlank("AB105", "9");
		setFieldValueIfBlank("AB106", "9");
		setFieldValueIfBlank("AB107", "9");
		setFieldValueIfBlank("AB108", "9");
		setFieldValueIfBlank("AB109", "9");
		setFieldValueIfBlank("AB110", "9");
		setFieldValueIfBlank("AB111", "9");
		setFieldValueIfBlank("AB112", "9");
		setFieldValueIfBlank("AB113", "9");
		setFieldValueIfBlank("AB114", "9");
		setFieldValueIfBlank("AB115", "9");
		setFieldValueIfBlank("AB116", "9");
		setFieldValueIfBlank("AB117", "9");
		setFieldValueIfBlank("AB118", "9");
		setFieldValueIfBlank("AB119", "9");
		setFieldValueIfBlank("AB120", "9");
		setFieldValueIfBlank("AB121", "9");
		setFieldValueIfBlank("AB122", "9");
		setFieldValueIfBlank("AB123", "9");
		setFieldValueIfBlank("AB124", "9");
	}
}
	</script>
						<def:dataentrycontroller id="DataEntryController1" runat="server" ShowScoreButton="True" StudyMeasID="351"
							LookupField1DataType="TEXT" VerifiedField="verified" PrimaryKeyField="anotb_pk" MeasureName="TAP A Not B"
							LookupTextBox1LabelText="TAP ID:" LookupTextBox2Visible="False" LookupField1="tapid" DatabaseTable="tap_anotb" ondoscore="DataEntryController1_DoScore"></def:dataentrycontroller>
						<table class="layout" id="table_insert">
							<tr>
								<td><def:datafieldcontrol id="tapid" runat="server" FieldLabelWidth="80px" FieldTextBoxWidth="80px" DatabaseField="tapid"
										FieldTextBoxTabIndex="2" FieldLabelText="TAP ID" IsDoubleEntryField="False" IsReadOnly="False" IsEntryValueRequired="False"
						...
						<asp:panel id="mainPanel" Runat="server">
							<def:datafieldcontrol id="AB1TRAIN" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
								...
								FieldTextBoxTabIndex="5" DatabaseField="AB1TRAIN" FieldTextBoxWidth="30px" ValidList="0,1,9" CallOnBlur="unselectAB1TRAIN"></def:datafieldcontrol>
							<BR>
							...
							<TABLE class="layout">
								<TR>
									...
									<TD style="vertical-align:top"><SPAN style="COLOR: green">Calculated values are in green</SPAN>
												...
												<TD width="311">
													<def:datafieldcontrol id="AB14RV12" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
														...
														<def:datafieldcontrol id="AB1REV4C" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
															...
															ShowFieldLabel="False" DESIGNTIMEDRAGDROP="815"></def:datafieldcontrol></SPAN></TD>
											</TR>
										</TABLE>
										<SPAN style="COLOR: green">
											<def:datafieldcontrol id="AB1FS12C" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
												IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="True" IsDoubleEntryField="False" FieldLabelText="First 12 sec trial:"
												FieldTextBoxTabIndex="6" DatabaseField="AB1FS12C" FieldTextBoxWidth="30px" FieldLabelWidth="100px"
												MaxVal="24" RenderReadOnlyAsDiv="True" ShowFieldLabel="True"></def:datafieldcontrol></SPAN>
										<def:datafieldcontrol id="AB1LASTC" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
											IsEntryField="False" IsEntryValueRequired="False" IsReadOnly="True" IsDoubleEntryField="False" FieldLabelText="Last trial:"
											FieldTextBoxTabIndex="6" DatabaseField="AB1LASTC" FieldTextBoxWidth="30px" FieldLabelWidth="100px"
											MaxVal="24" RenderReadOnlyAsDiv="True" ShowFieldLabel="True"></def:datafieldcontrol><BR>
											...
											<TR>
												...
												<TD width="79">
													<def:datafieldcontrol id="AB15OCO" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
														...
														<def:datafieldcontrol id="AB15OCC" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
															...
															ShowFieldLabel="False" DESIGNTIMEDRAGDROP="884"></def:datafieldcontrol></SPAN></TD>
												<TD>
													<def:datafieldcontrol id="AB15OTR" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
														...
														<def:datafieldcontrol id="AB15OTC" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
															...
															ShowFieldLabel="False" DESIGNTIMEDRAGDROP="885"></def:datafieldcontrol></SPAN></TD>
												<TD><SPAN style="COLOR: green">
														<def:datafieldcontrol id="AB15OPCT" runat="server" FieldDataType="FLOAT" IsInsertField="False" IsInsertValueRequired="False"
															...
															RenderReadOnlyAsDiv="True" ShowFieldLabel="False" DESIGNTIMEDRAGDROP="24"></def:datafieldcontrol></SPAN></TD>
											</TR>
											<TR>
												...
												<TD width="79">
													<def:datafieldcontrol id="AB15RCOU" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
														...
														<def:datafieldcontrol id="AB15RCO" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
															...
															ShowFieldLabel="False" DESIGNTIMEDRAGDROP="23" Width="103px"></def:datafieldcontrol></SPAN></TD>
												<TD>
													<def:datafieldcontrol id="AB15RTRU" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
														...
														<def:datafieldcontrol id="AB15RTR" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
															...
															ShowFieldLabel="False" DESIGNTIMEDRAGDROP="146"></def:datafieldcontrol></SPAN></TD>
												<TD><SPAN style="COLOR: green">
												...
												<TD width="79">
													<def:datafieldcontrol id="AB112OCO" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
														...
														<def:datafieldcontrol id="AB112OCC" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
															...
															ShowFieldLabel="False" DESIGNTIMEDRAGDROP="886"></def:datafieldcontrol></SPAN></TD>
												<TD>
												...
												<TD>
													<def:datafieldcontrol id="AB112RTU" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
														...
														<def:datafieldcontrol id="AB112RTR" runat="server" FieldDataType="INT" IsInsertField="False" IsInsertValueRequired="False"
															...
															ShowFieldLabel="False" DESIGNTIMEDRAGDROP="160"></def:datafieldcontrol></SPAN></TD>
												<TD><SPAN style="COLOR: green">
