<%@ Page language="c#" Inherits="tap_jo.tap_jo" CodeFile="tap_jo.aspx.cs"  MasterPageFile="~/UWAC.master" %>

<%@ Register TagPrefix="def" Namespace="DataEntryFramework.Old" %>
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" DatabaseTable="tap_jo" LookupField1="tapid"
							LookupTextBox2Visible="False" LookupTextBox1LabelText="TAP ID:" MeasureName="TAP Joint Orient" PrimaryKeyField="jo_pk"
							VerifiedField="verified" LookupField1DataType="TEXT" StudyMeasID="364"></def:dataentrycontroller>
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="jobeh" runat="server" FieldTextBoxWidth="200px" FieldLabelWidth="80px" DatabaseField="jobeh"
											...
											FieldDataType="TEXT" FieldTextBoxHeight="150px" FieldTextBoxTextMode="MultiLine" FieldTextBoxMaxLength="500"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
