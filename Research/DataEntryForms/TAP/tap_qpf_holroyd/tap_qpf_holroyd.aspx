<%@ Page language="c#" Inherits="tap_qpf_holroyd.tap_qpf_holroyd" CodeFile="tap_qpf_holroyd.aspx.cs"  MasterPageFile="~/UWAC.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="oBodyPlaceHolder" runat="server">
						<def:dataentrycontroller id="DataEntryController1" runat="server" LookupField1="tapid" VerifiedField="verified"
							PrimaryKeyField="hol_pk" MeasureName="TAP Father Parent Stress (Holroyd)" LookupTextBox2Visible="False"
							LookupTextBox1LabelText="TAP ID:" DatabaseTable="tap_qpf_holroyd" LookupField1DataType="TEXT" ShowScoreButton="False" StudyMeasID="421"></def:dataentrycontroller>
						<table id="table_insert" class="layout">
							<tr>
								<td><def:datafieldcontrol id="TAPID" runat="server" FieldDataType="TEXT" IsInsertField="True" IsInsertValueRequired="True"
										IsEntryField="False" IsEntryValueRequired="True" IsReadOnly="False" IsDoubleEntryField="False" FieldLabelText="TAP ID"
										FieldTextBoxTabIndex="1" DatabaseField="tapid" RegEx="^[T][A][P][0-9][0-9][0-9]$" RegExDescription="TAP ID must  look like TAP###"
										FieldTextBoxWidth="100px"></def:datafieldcontrol>
								</td>
							</tr>
							<tr>
								<td><def:datafieldcontrol id="HOLdate" runat="server" FieldDataType="DATE" IsInsertField="True" IsInsertValueRequired="True"
										IsEntryField="True" IsEntryValueRequired="True" IsReadOnly="False" IsDoubleEntryField="False" FieldLabelText="Date"
										FieldTextBoxTabIndex="1" DatabaseField="HOLdate" FieldTextBoxWidth="100px" FormatString="{0:d}"></def:datafieldcontrol></td>
							</tr>
							<tr>
								<td>
									<def:datafieldcontrol id="HOLresp" runat="server" FieldDataType="INT" IsInsertField="True" IsInsertValueRequired="True"
										...
										FieldTextBoxTabIndex="2" DatabaseField="HOLresp" FieldTextBoxWidth="100px" ValidList="1,2,3,4,9"></def:datafieldcontrol>
								</td>
							</tr>
						</table>
						<br/>
						<asp:panel id="mainPanel" runat="server">
							...
							<def:datafieldcontrol id="HOL1CMNT" runat="server" FieldTextBoxWidth="200px" DatabaseField="HOL1CMNT"
								...
								FieldDataType="TEXT" FieldTextBoxTextMode="MultiLine" FieldTextBoxHeight="150px" FieldTextBoxMaxLength="255"></def:datafieldcontrol>
							<br/>
							<br/>
								...
								<TR>
									<TD>
										<def:datafieldcontrol id="created" runat="server" DatabaseField="created" FieldTextBoxTabIndex="84" FieldLabelText="created"
											...
											IsInsertField="False" FieldDataType="DATE" RenderReadOnlyAsDiv="True" FieldLabelWidth="80px"></def:datafieldcontrol></TD>
								</TR>
								<TR>
									<TD>
